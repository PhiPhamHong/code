<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Video_Streaming_BlogDetail.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Blogspots.Video_Streaming.Pages.Video_Streaming_BlogDetail" %>
                ...
                <div class="col-md-12">
                    <div class="main-title">
                        <div class="btn-group float-right right-action">
                            <a aria-expanded="false" aria-haspopup="true" data-toggle="dropdown" class="right-action-link text-gray" href="#">Sort by <i aria-hidden="true" class="fa fa-caret-down"></i>
                            </a>
                ...
                <div class="col-md-8">
                    <div class="card blog mb-4">
                        <div class="blog-header">
                            <a href="">
                                <img class="card-img-top" src="/Projects/Blogspots/Video_Streaming/Resources/img/blog/2.png" alt="Card image cap"></a>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title"><a href="">Aliquam euismod libero eu enim. Nulla nec felis sed leo.</a></h5>
                            <div class="entry-meta">
                                <ul class="tag-info list-inline">
                                    <li class="list-inline-item"><a href="#"><i class="fas fa-calendar"></i>March 6, 2018</a></li>
                            ...
                            <div class="gallery mb-4">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <img class="rounded" alt="" src="/Projects/Blogspots/Video_Streaming/Resources/img/blog/3.png"></div>
                                    <div class="col-sm-4">
                                        <img class="rounded" alt="" src="/Projects/Blogspots/Video_Streaming/Resources/img/blog/2.png"></div>
                                    <div class="col-sm-4">
                                        <img class="rounded" alt="" src="/Projects/Blogspots/Video_Streaming/Resources/img/blog/1.png"></div>
                                </div>
                            </div>
                            <p>Praesent aliquam, enim at fermentum mollis, ligula massa adipiscing nisl, ac euismod nibh nisl eu lectus. Fusce vulputate sem at sapien. Vivamus leo. Aliquam euismod libero eu enim. Nulla nec felis sed leo placerat imperdiet. Aenean suscipit nulla in justo.</p>
                            ...
                            <div class="gallery mt-4 mb-4">
                                <div class="row">
                                    <div class="col-sm-6">
                                        <img alt="" class="rounded" src="/Projects/Blogspots/Video_Streaming/Resources/img/blog/2.png"></div>
                                    <div class="col-sm-6">
                                        <img alt="" class="rounded" src="/Projects/Blogspots/Video_Streaming/Resources/img/blog/3.png"></div>
                                </div>
                            </div>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Non, ipsum facilis, eaque aliquid porro deleniti architecto eum perferendis quidem modi quo reiciendis dolor deserunt beatae repellat, nostrum aut fuga. Rem?</p>
                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reiciendis sunt a quam, exercitationem, provident numquam quia eius optio quos vitae odio impedit ipsum voluptatem earum neque architecto enim quisquam, ea.</p>
                    ...
                    <div class="card padding-card reviews-card mb-4">
                        <div class="card-body">
                            ...
                            <div class="media mb-4">
                                <img alt="" src="/Projects/Blogspots/Video_Streaming/Resources/img/s2.png" class="d-flex mr-3 rounded">
                            ...
                            <div class="media">
                                <img alt="" src="/Projects/Blogspots/Video_Streaming/Resources/img/s1.png" class="d-flex mr-3 rounded">
                                <div class="media-body">
                                    ...
                                    <div class="media mt-4">
                                        <img alt="" src="/Projects/Blogspots/Video_Streaming/Resources/img/s3.png" class="d-flex mr-3 rounded">
                                        <div class="media-body">
                            ...
                            <div class="media mt-4">
                                <img alt="" src="/Projects/Blogspots/Video_Streaming/Resources/img/s4.png" class="d-flex mr-3 rounded">
                                <div class="media-body">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card sidebar-card mb-4">
                        <div class="card-body">
                            ...
                            <p class="mb-0"><i class="fas fa-calendar-text"></i>April 05, 2018</p>
                            <hr>
                            <a href="#">
                                <h6>Nulla malesuada mauris non nulla imperdiet ullamcorper</h6>
                            </a>
                            <p class="mb-0"><i class="fas fa-calendar-text"></i>June 20, 2018</p>
                            <hr>
                            <a href="#">
                                <h6 class="text-success">Focus on creating and growing your projects and websites</h6>
                            </a>
                            <p class="mb-0"><i class="fas fa-calendar-text"></i>June 29, 2018</p>
                            <hr>
                            <a href="#">
                                <h6>Vestibulum lobortis urna eu mauris viverra porttitor. Cras consequat </h6>
                            </a>
                            <p class="mb-0"><i class="fas fa-calendar-text"></i>October 10, 2018</p>
                            <hr>
                            <a href="#">
