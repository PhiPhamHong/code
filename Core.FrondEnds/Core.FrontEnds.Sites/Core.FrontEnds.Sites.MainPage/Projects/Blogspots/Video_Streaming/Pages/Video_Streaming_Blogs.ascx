<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Video_Streaming_Blogs.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Blogspots.Video_Streaming.Pages.Video_Streaming_Blogs" %>
                ...
                <div class="col-md-8">
                    <div class="card blog mb-4">
                        <div class="blog-header">
                            <a href="<%= Url("Video_Streaming_BlogDetail") %>">
                                <img class="card-img-top" src="/Projects/Blogspots/Video_Streaming/Resources/img/blog/1.png" alt="Card image cap"></a>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title"><a href="<%= Url("Video_Streaming_BlogDetail") %>">Aliquam euismod libero eu enim. Nulla nec felis sed leo.</a></h5>
                    ...
                    <div class="card blog mb-4">
                        <div class="blog-header">
                            <a href="<%= Url("Video_Streaming_BlogDetail") %>">
                                <img class="card-img-top" src="/Projects/Blogspots/Video_Streaming/Resources/img/blog/3.png" alt="Card image cap"></a>
                        </div>
                        <div class="card-body">
                            <h5 class="card-title"><a href="<%= Url("Video_Streaming_BlogDetail") %>">Aliquam euismod libero eu enim. Nulla nec felis sed leo.</a></h5>
                            <div class="entry-meta">
