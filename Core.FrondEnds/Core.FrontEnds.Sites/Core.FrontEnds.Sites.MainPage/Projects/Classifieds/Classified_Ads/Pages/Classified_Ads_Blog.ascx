<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Classified_Ads_Blog.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Classifieds.Classified_Ads.Pages.Classified_Ads_Blog" %>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="panel blog-box">
                    <div class="panel-heading">
                        <div class="media clearfix">
                            <a class="pull-left">
                                <img src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/user/a3.jpg" alt="profile-picture">
                            </a>
                    ...
                    <div class="panel-image">
                        ...
                        <div class="title">
                            <a href="<%= Url("Classified_Ads_BlogDetail") %>">
                ...
                <div class="panel blog-box">
                    <div class="panel-heading">
                        <div class="media clearfix">
                            <a class="pull-left">
                                <img src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/user/a5.jpg" alt="profile-picture">
                            </a>
                            <div class="media-body">
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<%= Url("Classified_Ads_BlogDetail") %>" class="btn btn-primary btn-xs">Read more</a>
                    </div>
                </div>
                <div class="panel blog-box">
                    <div class="panel-heading">
                        <div class="media clearfix">
                            <a class="pull-left">
                                <img src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/user/a6.jpg" alt="profile-picture">
                            </a>
                            <div class="media-body">
                                <small>Created by: <span class="font-bold">John Wilkins</span> </small>
                                <br>
            ...
            <div class="col-md-3">
                <div class="panel blog-box">
                    <div class="panel-heading">
                        <div class="media clearfix">
                            <a class="pull-left">
                                <img src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/user/a1.jpg" alt="profile-picture">
                            </a>
                            <div class="media-body">
                ...
                <div class="panel blog-box">
                    <div class="panel-heading">
                        <div class="media clearfix">
                            <a class="pull-left">
                                <img src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/user/a7.jpg" alt="profile-picture">
                            </a>
                            <div class="media-body">
                ...
                <div class="panel blog-box">
                    <div class="panel-heading">
                        <div class="media clearfix">
                            <a class="pull-left">
                                <img src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/user/a4.jpg" alt="profile-picture">
                            </a>
                            <div class="media-body">
            ...
            <div class="col-md-3">
                <div class="panel blog-box">
                    <div class="panel-heading">
                        <div class="media clearfix">
                            <a class="pull-left">
                                <img src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/user/a2.jpg" alt="profile-picture">
                            </a>
                            <div class="media-body">
                ...
                <div class="panel blog-box">
                    <div class="panel-heading">
                        <div class="media clearfix">
                            <a class="pull-left">
                                <img src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/user/a8.jpg" alt="profile-picture">
                            </a>
                            <div class="media-body">
                                <small>Created by: <span class="font-bold">Selena Jackson</span> </small>
                                <br>
                    ...
                    <div class="panel-image">
                        <img class="img-responsive" src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/blog-03.jpg" alt="">
                        <div class="title">
                            <a href="<%= Url("Classified_Ads_BlogDetail") %>">
            ...
            <div class="col-md-3">
                <div class="panel blog-box">
                    ...
                    <div class="panel-image">
                        <img class="img-responsive" src="/Projects/Classifieds/Classified_Ads/Resources/images/blog/blog-02.jpg" alt="">
                        <div class="title">
                            <a href="<%= Url("Classified_Ads_BlogDetail") %>">
                                <h4>Standard chunk of Lorem Ipsum</h4>
                            </a>
