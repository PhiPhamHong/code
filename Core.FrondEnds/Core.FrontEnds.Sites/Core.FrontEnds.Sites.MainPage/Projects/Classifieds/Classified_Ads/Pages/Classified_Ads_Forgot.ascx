<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Classified_Ads_Forgot.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Classifieds.Classified_Ads.Pages.Classified_Ads_Forgot" %>
