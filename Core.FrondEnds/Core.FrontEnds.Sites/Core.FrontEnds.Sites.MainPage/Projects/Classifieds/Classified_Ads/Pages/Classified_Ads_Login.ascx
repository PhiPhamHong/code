<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Classified_Ads_Login.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Classifieds.Classified_Ads.Pages.Classified_Ads_Login" %>
            ...
            <div class="col-sm-4 col-sm-offset-4">
                <div class="login-panel widget">
                    ...
                    <div class="login-footer">
                        ...
                        <p class="text-center pull-right"><a href="<%= Url("Classified_Ads_Forgot") %>">Forgot password? </a></p>
                        <div class="clearfix"></div>
                    </div>
                </div>
                <p class="text-center margin-bottom-none">Don't have an account? <a href="<%= Url("Classified_Ads_Register") %>"><strong>Signup</strong></a></p>
            </div>
        </div>
    </div>
</section>
