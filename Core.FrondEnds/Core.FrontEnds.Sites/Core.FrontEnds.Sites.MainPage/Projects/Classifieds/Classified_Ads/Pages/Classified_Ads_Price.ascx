<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Classified_Ads_Price.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Classifieds.Classified_Ads.Pages.Classified_Ads_Price" %>
            ...
            <div class="col-md-4">
                <div class="panel panel-default text-center basic-plan margin-bottom-none">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><a href="<%= Url("Classified_Ads_Login") %>" class="btn btn-primary">Sign Up!</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
                <div class="panel panel-primary text-center advanced-plan margin-bottom-none">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><i class="fa fa-check-square text-primary"></i>6&nbsp;Featured ads availability</li>
                        <li class="list-group-item"><i class="fa fa-check-square text-primary"></i>10GB Disk Space</li>
                        <li class="list-group-item"><i class="fa fa-check-square text-primary"></i>100% Secure! <a href="<%= Url("Classified_Ads_Login") %>" data-toggle="tooltip" data-placement="top" title="Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae,">&nbsp;<i class="fa fa-info-circle"></i></a></li>
                        <li class="list-group-item"><a href="<%= Url("Classified_Ads_Login") %>" class="btn btn-primary btn-lg">Sign Up!</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-md-4">
