<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Classified_Ads_Register.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Classifieds.Classified_Ads.Pages.Classified_Ads_Register" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <p class="text-center margin-bottom-none"><a href="<%= Url("Classified_Ads_Login") %>"><strong>Have an account? </strong></a></p>
            </div>
        </div>
    </div>
</section>
