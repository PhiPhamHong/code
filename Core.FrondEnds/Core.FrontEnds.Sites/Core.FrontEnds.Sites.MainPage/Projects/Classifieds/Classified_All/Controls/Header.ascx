<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Header.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Classifieds.Classified_All.Controls.Header" %>
    ...
    <div class="container">
        <div class="row margin-none">
            <div class="navbar-header col-sm-2">
                ...
                <a class="navbar-brand" href="<%= Url("Classified_All") %>">
                    <img alt="logo" src="/Projects/Classifieds/Classified_All/Resources/images/logo.png"></a>
            </div>
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<%= Url("Classified_All_Categories") %>"><i class="fa fa-fw fa-angle-right"></i>Categories</a>
                            </li>

                            <li>
                                <a href="<%= Url("Classified_All_Single") %>"><i class="fa fa-fw fa-angle-right"></i>Ads Detail </a>
                            </li>
                        </ul>
                    </li>
                    <li><a href="<%= Url("Classified_All_FAQ") %>">FAQ</a></li>
                    <li><a href="<%= Url("Classified_All_Contact") %>">Contact Us</a></li>
                    <li class="dropdown">
                        <a data-toggle="dropdown" class="dropdown-toggle" href="" aria-expanded="false">Blog <b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<%= Url("Classified_All_Blog") %>"><i class="fa fa-fw fa-angle-right"></i>Blog</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_BlogDetail") %>"><i class="fa fa-fw fa-angle-right"></i>Blog Details</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<%= Url("Classified_All_Price") %>"><i class="fa fa-fw fa-angle-right"></i>Pricing</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_Privacy") %>"><i class="fa fa-fw fa-angle-right"></i>Privacy Policy</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_404") %>"><i class="fa fa-fw fa-angle-right"></i>404 Not Found</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="<%= Url("Classified_All_Settings") %>"><i class="fa fa-fw fa-angle-right"></i>Profile</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_Post") %>"><i class="fa fa-fw fa-angle-right"></i>Post Your Ad</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_Settings") %>"><i class="fa fa-fw fa-angle-right"></i>Settings</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_MyAds") %>"><i class="fa fa-fw fa-angle-right"></i>My Ads</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_Alert") %>"><i class="fa fa-fw fa-angle-right"></i>AD Alert</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_Favourites") %>"><i class="fa fa-fw fa-angle-right"></i>Favourite Ads</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_Close") %>"><i class="fa fa-fw fa-angle-right"></i>Close account</a>
                            </li>
                            <li>
                                <a href="<%= Url("Classified_All_Login") %>"><i class="fa fa-fw fa-power-off"></i>Log Out</a>
                            </li>
                        </ul>
                    </li>
                </ul>
                <div class="user-login pull-right">
                    ...
                    <%else %>
                    <%{ %>
                    <a href="<%= Url("Classified_All_Register") %>">REGISTER</a>
                    <span>or</span>
                    <a class="btn btn-md btn-primary" href="<%= Url("Classified_All_Login") %>">Sign In</a>
                    <%} %>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="top-categories margin-bottom-none col-md-12">
                    ...
                    <a href="<%= Url("Classified_All_Categories") %>">
...
<div class="fixed-categories-nav">
    <a data-toggle="tooltip" data-placement="left" title="" href="#Restaurant">
        <i class="fa fa-glass shortcut-icon icon-blue"></i>
    </a>
    <a data-toggle="tooltip" data-placement="left" title="" href="#Real_Estate" data-original-title="Real-Estate">
        <i class="fa fa-home shortcut-icon icon-green"></i>
    </a>
    <a data-toggle="tooltip" data-placement="left" title="" href="#Cars" data-original-title="Cars">
        <i class="fa fa-car shortcut-icon icon-brown"></i>
    </a>
    <a data-toggle="tooltip" data-placement="left" title="" href="#Shopping" data-original-title="Shopping">
        <i class="fa fa-shopping-cart shortcut-icon icon-violet"></i>
    </a>
    <a data-toggle="tooltip" data-placement="left" title="" href="#Job" data-original-title="Job">
        <i class="fa fa-briefcase shortcut-icon icon-dark-blue"></i>
    </a>
    <a data-toggle="tooltip" data-placement="left" title="" href="#Hotels" data-original-title="Hotels">
        <i class="fa fa-building-o shortcut-icon icon-orange"></i>
    </a>
    <a data-toggle="tooltip" data-placement="left" title="" href="#Services" data-original-title="Services">
        <i class="fa fa-star shortcut-icon icon-light-blue"></i>
    </a>
    <a data-toggle="tooltip" data-placement="left" title="" href="#Pets" data-original-title="Pets">
        <i class="fa fa-paw shortcut-icon icon-light-green"></i>
    </a>
</div>
