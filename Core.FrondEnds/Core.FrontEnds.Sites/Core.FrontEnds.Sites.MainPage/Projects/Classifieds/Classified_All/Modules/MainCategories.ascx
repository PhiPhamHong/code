<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MainCategories.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Classifieds.Classified_All.Modules.MainCategories" %>
                ...
                <div class="single-categorie">
                    <div id="owl-carousel-featured" class="owl-carousel categories-list-page">
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-blue">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/restaurant/2.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>There are many variations</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-blue">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/restaurant/3.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>There are many variations</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-blue">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/restaurant/4.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>There are many variations</h4>
                                        </a>
                ...
                <div class="single-categorie">
                    <div id="owl-carousel-featured" class="owl-carousel categories-list-page">
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-green">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/real_estate/2.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Lorem Ipsum is simply</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-green">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/real_estate/3.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Lorem Ipsum is simply</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-green">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/real_estate/4.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Lorem Ipsum is simply</h4>
                                        </a>
                ...
                <div class="single-categorie">
                    <div id="owl-carousel-featured" class="owl-carousel categories-list-page">
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-brown">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/cars/2.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>It is a long established</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-brown">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/cars/3.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>It is a long established</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-brown">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/cars/4.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>It is a long established</h4>
                                        </a>
                ...
                <div class="single-categorie">
                    <div id="owl-carousel-featured" class="owl-carousel categories-list-page">
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-violet">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/shopping/2.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Passage of Lorem Ipsum </h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-violet">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/shopping/3.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Passage of Lorem Ipsum </h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-violet">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/shopping/4.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Passage of Lorem Ipsum </h4>
                                        </a>
                ...
                <div class="single-categorie">
                    <div id="owl-carousel-featured" class="owl-carousel categories-list-page">
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-dark-blue">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/job/2.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Lorem Ipsum is simply</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-dark-blue">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/job/3.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Lorem Ipsum is simply</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-dark-blue">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/job/4.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Lorem Ipsum is simply</h4>
                                        </a>
                ...
                <div class="single-categorie">
                    <div id="owl-carousel-featured" class="owl-carousel categories-list-page">
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-orange">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/hotels/2.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Passage of Lorem Ipsum</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-orange">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/hotels/3.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Passage of Lorem Ipsum</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-orange">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/hotels/4.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Passage of Lorem Ipsum</h4>
                                        </a>
                ...
                <div class="single-categorie">
                    <div id="owl-carousel-featured" class="owl-carousel categories-list-page">
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-light-blue">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/services/2.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>There are many variations</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-light-blue">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/services/3.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>There are many variations</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-light-blue">
                                ...
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/services/4.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>There are many variations</h4>
                                        </a>
                ...
                <div class="single-categorie">
                    <div id="owl-carousel-featured" class="owl-carousel categories-list-page">
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-light-green">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/pets/2.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Lorem Ipsum is simply</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-light-green">
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/pets/3.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Lorem Ipsum is simply</h4>
                                        </a>
                        ...
                        <div class="item">
                            <div class="item-ads-grid icon-light-green">
                                ...
                                <div class="item-img-grid">
                                    <img alt="" src="/Projects/Classifieds/Classified_All/Resources/images/categories/pets/4.png" class="img-responsive img-center">
                                    <div class="item-title">
                                        <a href="<%= Url("Classified_All_Single") %>">
                                            <h4>Lorem Ipsum is simply</h4>
                                        </a>
