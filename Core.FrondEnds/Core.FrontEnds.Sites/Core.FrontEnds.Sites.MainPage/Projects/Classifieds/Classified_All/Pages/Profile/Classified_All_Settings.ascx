<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Classified_All_Settings.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Classifieds.Classified_All.Pages.Profile.Classified_All_Settings" %>
                ...
                <div class="widget listing-filter-block margin-bottom-none">
                    ...
                    <div class="widget-body">
                        <div class="similar-ads">
                            <a href="<%= Url("Classified_All_Single") %>">
                                <div class="similar-ad-left">
                                    <img class="img-responsive img-center" src="/Projects/Classifieds/Classified_All/Resources/images/categories/restaurant/1.png" alt="">
                                </div>
                        ...
                        <div class="similar-ads">
                            <a href="<%= Url("Classified_All_Single") %>">
                                <div class="similar-ad-left">
                                    <img class="img-responsive img-center" src="/Projects/Classifieds/Classified_All/Resources/images/categories/pets/1.png" alt="">
                                </div>
                                <div class="similar-ad-right">
                                    <h4>Duis autem vel eum iriure do hen...</h4>
                                    <p><i class="fa fa-dollar"></i>450 - <i class="fa fa-map-marker"></i>Buffalo </p>
                        ...
                        <div class="similar-ads">
                            <a href="<%= Url("Classified_All_Single") %>">
                                <div class="similar-ad-left">
                                    <img class="img-responsive img-center" src="/Projects/Classifieds/Classified_All/Resources/images/categories/real_estate/2.png" alt="">
                                </div>
                                <div class="similar-ad-right">
                                    <h4>Duis autem vel eum iriure do hen...</h4>
                                    <p><i class="fa fa-dollar"></i>450 - <i class="fa fa-map-marker"></i>Buffalo </p>
                        ...
                        <div class="similar-ads">
                            <a href="<%= Url("Classified_All_Single") %>">
                                <div class="similar-ad-left">
                                    <img class="img-responsive img-center" src="/Projects/Classifieds/Classified_All/Resources/images/categories/cars/1.png" alt="">
                                </div>
                                <div class="similar-ad-right">
                                    <h4>Duis autem vel eum iriure do hen...</h4>
                                    <p><i class="fa fa-dollar"></i>450 - <i class="fa fa-map-marker"></i>Buffalo </p>
                        ...
                        <div class="similar-ads">
                            <a href="<%= Url("Classified_All_Single") %>">
                                <div class="similar-ad-left">
                                    <img class="img-responsive img-center" src="/Projects/Classifieds/Classified_All/Resources/images/categories/job/1.png" alt="">
                                </div>
                                <div class="similar-ad-right">
                                    <h4>Duis autem vel eum iriure do hen...</h4>
                                    <p><i class="fa fa-dollar"></i>450 - <i class="fa fa-map-marker"></i>Buffalo </p>
