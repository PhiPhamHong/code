<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Footer.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForRent.Controls.Footer" %>
<section class="section-padding footer">
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <h4 class="mb-5 mt-0"><a class="logo" href="<%= Url("Home_ForRent") %>">
                    <img src="/Projects/Homes/Home_ForRent/Resources/img/logo.png" alt="osahan logo"></a></h4>
