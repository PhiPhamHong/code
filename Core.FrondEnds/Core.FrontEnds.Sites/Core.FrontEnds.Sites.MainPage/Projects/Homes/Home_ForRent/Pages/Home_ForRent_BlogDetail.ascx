<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForRent_BlogDetail.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForRent.Pages.Home_ForRent_BlogDetail" %>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="breadcrumbs">
                    <p class="mb-0"><a href="<%= Url("Home_ForRent") %>"><i class="mdi mdi-home-outline"></i>Home</a> / Blog Single</p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card padding-card reviews-card">
                    <div class="card-body">
                        ...
                        <div class="media mb-4">
                            <img class="d-flex mr-3 rounded" src="/Projects/Homes/Home_ForRent/Resources/img/user/1.jpg" alt="">
                        ...
                        <div class="media">
                            <img class="d-flex mr-3 rounded" src="/Projects/Homes/Home_ForRent/Resources/img/user/2.jpg" alt="">
                            <div class="media-body">
                                ...
                                <div class="media mt-4">
                                    <img class="d-flex mr-3 rounded" src="/Projects/Homes/Home_ForRent/Resources/img/user/3.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <div class="media mt-4">
                            <img class="d-flex mr-3 rounded" src="/Projects/Homes/Home_ForRent/Resources/img/user/5.jpg" alt="">
                            <div class="media-body">
