<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForRent_Forget.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForRent.Pages.Home_ForRent_Forget" %>
                ...
                <div class="card padding-card">
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center">
                            Don't have an account? <a href="<%= Url("Home_ForRent_Register") %>">Register</a>
                        </div>
                    </div>
                </div>
            </div>
