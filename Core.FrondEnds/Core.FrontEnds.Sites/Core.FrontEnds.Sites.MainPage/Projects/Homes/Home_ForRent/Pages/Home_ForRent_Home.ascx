<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForRent_Home.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForRent.Pages.Home_ForRent_Home" %>
...
<section class="osahan-slider">
    ...
    <div class="slider-form">
        <div class="container">
            <h2 class="text-left mb-5 text-white">Find Your Dream Home</h2>
            <form>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_ForRent_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_ForRent/Resources/img/overlay/1.png" alt="Card image">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_ForRent_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_ForRent/Resources/img/overlay/2.png" alt="Card image">
                        <div class="card-img-overlay">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_ForRent_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_ForRent/Resources/img/overlay/3.png" alt="Card image">
                        <div class="card-img-overlay">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_ForRent_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_ForRent/Resources/img/overlay/4.png" alt="Card image">
                        <div class="card-img-overlay">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="agents-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Homes/Home_ForRent/Resources/img/user/1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="agents-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Homes/Home_ForRent/Resources/img/user/2.jpg" alt="">
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="agents-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Homes/Home_ForRent/Resources/img/user/3.jpg" alt="">
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
