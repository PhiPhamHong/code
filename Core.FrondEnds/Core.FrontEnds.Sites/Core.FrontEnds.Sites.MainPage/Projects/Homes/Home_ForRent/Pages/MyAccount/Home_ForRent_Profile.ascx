<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForRent_Profile.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForRent.Pages.MyAccount.Home_ForRent_Profile" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link active text-success" href="<%= Url("Home_ForRent_Profile") %>">User Profile</a>
                    </li>
                    <li class="nav-item">
