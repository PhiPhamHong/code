<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForSale_Agencies.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForSale.Pages.Home_ForSale_Agencies" %>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="breadcrumbs">
                    <p class="mb-0"><a href="<%= Url("Home_ForSale") %>"><i class="mdi mdi-home-outline"></i>Home</a> / Agency List</p>
                </div>
            </div>
        </div>
    </div>
                            ...
                            <a href="<%= Url("Home_ForSale_AgencyProfile") %>">
                                <div class="row no-gutters">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <img class="card-img-top" src="/Projects/Homes/Home_ForSale/Resources/img/agency-list/1.png" alt="Card image cap">
                                    </div>
                            ...
                            <a href="<%= Url("Home_ForSale_AgencyProfile") %>">
                                <div class="row no-gutters">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <img class="card-img-top" src="/Projects/Homes/Home_ForSale/Resources/img/agency-list/2.png" alt="Card image cap">
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="card-body">
                                            <h3>Rodeo Realty</h3>
                            ...
                            <a href="<%= Url("Home_ForSale_AgencyProfile") %>">
                                <div class="row no-gutters">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <img class="card-img-top" src="/Projects/Homes/Home_ForSale/Resources/img/agency-list/3.png" alt="Card image cap">
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="card-body">
                            ...
                            <a href="<%= Url("Home_ForSale_AgencyProfile") %>">
                                <div class="row no-gutters">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <img class="card-img-top" src="/Projects/Homes/Home_ForSale/Resources/img/agency-list/4.png" alt="Card image cap">
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="card-body">
                                            <h3>House in Kent Street</h3>
                            ...
                            <a href="<%= Url("Home_ForSale_AgencyProfile") %>">
                                <div class="row no-gutters">
                                    <div class="col-lg-4 col-md-4">
                                        ...
                                        <img class="card-img-top" src="/Projects/Homes/Home_ForSale/Resources/img/agency-list/5.png" alt="Card image cap">
                                    </div>
                                    <div class="col-lg-8 col-md-8">
                                        <div class="card-body">
                                            <h3>Rodeo Realty</h3>
