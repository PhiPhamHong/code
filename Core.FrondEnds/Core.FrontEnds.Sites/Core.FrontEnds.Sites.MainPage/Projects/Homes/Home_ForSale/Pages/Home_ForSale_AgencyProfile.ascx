<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForSale_AgencyProfile.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForSale.Pages.Home_ForSale_AgencyProfile" %>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="breadcrumbs">
                    <p class="mb-0"><a href="<%= Url("Home_ForSale") %>"><i class="mdi mdi-home-outline"></i>Home</a> / Agency Profile</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-5">
                <img class="rounded img-fluid" src="/Projects/Homes/Home_ForSale/Resources/img/agent.jpg" alt="Card image cap">
            </div>
