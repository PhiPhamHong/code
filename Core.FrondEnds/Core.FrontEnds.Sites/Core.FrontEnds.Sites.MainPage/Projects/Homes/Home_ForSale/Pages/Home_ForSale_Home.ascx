<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForSale_Home.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForSale.Pages.Home_ForSale_Home" %>
    ...
    <div class="slider-form">
        <div class="container">
            ...
            <div class="top-search">
                <strong class=""><i class="mdi mdi-keyboard"></i>Top Search</strong>
                <a href="">Flat</a>
                <a href="">Plot/Land</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_ForSale_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_ForSale/Resources/img/overlay/1.png" alt="Card image">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_ForSale_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_ForSale/Resources/img/overlay/2.png" alt="Card image">
                        <div class="card-img-overlay">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_ForSale_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_ForSale/Resources/img/overlay/3.png" alt="Card image">
                        <div class="card-img-overlay">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_ForSale_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_ForSale/Resources/img/overlay/4.png" alt="Card image">
                        <div class="card-img-overlay">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="agents-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Homes/Home_ForSale/Resources/img/user/1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="agents-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Homes/Home_ForSale/Resources/img/user/2.jpg" alt="">
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="agents-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Homes/Home_ForSale/Resources/img/user/3.jpg" alt="">
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
                    ...
                    <a href="<%= Url("Home_ForSale_BlogDetail") %>">
                        ...
                        <div class="card-footer">
                            <p class="mb-0">
                                ...
                                <strong>Rahul Yadav</strong> On October 03, 2018
                            </p>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="<%= Url("Home_ForSale_BlogDetail") %>">
                        ...
                        <div class="card-footer">
                            <p class="mb-0">
                                ...
                                <strong>Rahul Yadav</strong> On October 05, 2018
                            </p>
                        </div>
                    </a>
                </div>
                    ...
                    <a href="<%= Url("Home_ForSale_BlogDetail") %>">
                        ...
                        <div class="card-footer">
                            <p class="mb-0">
                                ...
                                <strong>Rahul Yadav</strong> On October 06, 2018
                            </p>
                        </div>
                    </a>
                </div>
