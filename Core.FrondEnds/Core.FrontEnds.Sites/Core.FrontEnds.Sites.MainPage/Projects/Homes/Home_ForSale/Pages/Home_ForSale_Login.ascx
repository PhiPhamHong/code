<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForSale_Login.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForSale.Pages.Home_ForSale_Login" %>
                ...
                <div class="card padding-card">
                    <div class="card-body">
                        ...
                        <div class="mt-4 text-center">
                            <a href="<%= Url("Home_ForSale_Login") %>">Forget your password?</a>
                        </div>
                    </div>
                </div>
            </div>
