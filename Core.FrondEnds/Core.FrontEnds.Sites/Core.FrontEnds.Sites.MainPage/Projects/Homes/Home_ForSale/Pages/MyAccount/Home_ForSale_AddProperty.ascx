<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForSale_AddProperty.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForSale.Pages.MyAccount.Home_ForSale_AddProperty" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-success" href="<%= Url("Home_ForSale_AddProperty") %>">Add Property</a>
                    </li>
                </ul>
            </div>
        </div>
