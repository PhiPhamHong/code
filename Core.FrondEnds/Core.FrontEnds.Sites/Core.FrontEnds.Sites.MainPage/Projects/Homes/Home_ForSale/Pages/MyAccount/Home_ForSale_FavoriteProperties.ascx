<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_ForSale_FavoriteProperties.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_ForSale.Pages.MyAccount.Home_ForSale_FavoriteProperties" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav justify-content-center">
                    <li class="nav-item">
                        <a class="nav-link" href="<%= Url("Home_ForSale_Profile") %>">User Profile</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<%= Url("Home_ForSale_MyProperties") %>">My Properties</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active text-primary" href="<%= Url("Home_ForSale_FavoriteProperties") %>">Favorite Properties</a>
                    </li>
                    <li class="nav-item">
