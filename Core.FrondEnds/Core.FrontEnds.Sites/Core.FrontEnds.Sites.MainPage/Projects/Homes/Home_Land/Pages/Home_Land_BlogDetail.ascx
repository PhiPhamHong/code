<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_Land_BlogDetail.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_Land.Pages.Home_Land_BlogDetail" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="mt-0 mb-3">Blog Single</h1>
                <div class="breadcrumbs">
                    <p class="mb-0"><a href="<%= Url("Home_Land") %>"><i class="mdi mdi-home-outline"></i>Home</a> / Blog Single</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card blog-card padding-card">
                    ...
                    <div class="card-body">
                        ...
                        <h6 class="mb-3"><i class="mdi mdi-calendar-text"></i>March 09, 2018 / 3 Comments</h6>
                        <p>
                ...
                <div class="card padding-card reviews-card">
                    <div class="card-body">
                        ...
                        <div class="media mb-4">
                            <img class="d-flex mr-3 rounded" src="/Projects/Homes/Home_Land/Resources/img/user/1.jpg" alt="">
                        ...
                        <div class="media">
                            <img class="d-flex mr-3 rounded" src="/Projects/Homes/Home_Land/Resources/img/user/2.jpg" alt="">
                            <div class="media-body">
                                ...
                                <div class="media mt-4">
                                    <img class="d-flex mr-3 rounded" src="/Projects/Homes/Home_Land/Resources/img/user/3.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <div class="media mt-4">
                            <img class="d-flex mr-3 rounded" src="/Projects/Homes/Home_Land/Resources/img/user/5.jpg" alt="">
                            <div class="media-body">
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="card sidebar-card">
                    <div class="card-body">
                        ...
                        <hr>
                        <a href="<%= Url("Home_Land_BlogDetail") %>">
                            <h6 class="text-primary">Focus on creating and growing your projects and websites</h6>
                        </a>
