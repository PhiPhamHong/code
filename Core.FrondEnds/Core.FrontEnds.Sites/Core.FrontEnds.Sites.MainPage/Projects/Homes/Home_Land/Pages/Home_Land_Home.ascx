<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_Land_Home.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_Land.Pages.Home_Land_Home" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-8">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_Land_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_Land/Resources/img/overlay/1.png" alt="Card image">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_Land_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_Land/Resources/img/overlay/2.png" alt="Card image">
                        <div class="card-img-overlay">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_Land_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_Land/Resources/img/overlay/3.png" alt="Card image">
                        <div class="card-img-overlay">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="card bg-dark text-white card-overlay">
                    <a href="<%= Url("Home_Land_Properties") %>">
                        <img class="card-img" src="/Projects/Homes/Home_Land/Resources/img/overlay/4.png" alt="Card image">
                        <div class="card-img-overlay">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="agents-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Homes/Home_Land/Resources/img/user/1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="agents-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Homes/Home_Land/Resources/img/user/2.jpg" alt="">
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="agents-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Homes/Home_Land/Resources/img/user/3.jpg" alt="">
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
