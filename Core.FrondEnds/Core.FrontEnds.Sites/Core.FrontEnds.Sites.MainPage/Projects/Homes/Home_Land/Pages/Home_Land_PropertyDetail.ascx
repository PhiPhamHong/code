<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_Land_PropertyDetail.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_Land.Pages.Home_Land_PropertyDetail" %>
            ...
            <div class="col-lg-8 col-md-8">
                ...
                <div class="card padding-card">
                    <div class="card-body">
                        ...
                        <a href="">
                            <img class="rounded img-fluid" src="/Projects/Homes/Home_Land/Resources/img/video.jpg" alt="Card image cap"></a>
                    </div>
                </div>
                <div class="card padding-card reviews-card">
                    <div class="card-body">
                        ...
                        <div class="media mb-4">
                            <img class="d-flex mr-3 rounded-circle" src="/Projects/Homes/Home_Land/Resources/img/user/1.jpg" alt="">
                        ...
                        <div class="media">
                            <img class="d-flex mr-3 rounded-circle" src="/Projects/Homes/Home_Land/Resources/img/user/2.jpg" alt="">
                            <div class="media-body">
                                ...
                                <div class="media mt-4">
                                    <img class="d-flex mr-3 rounded-circle" src="/Projects/Homes/Home_Land/Resources/img/user/3.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <div class="media mt-4">
                            <img class="d-flex mr-3 rounded-circle" src="/Projects/Homes/Home_Land/Resources/img/user/4.jpg" alt="">
                            <div class="media-body">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <div class="card card-list">
                                        <a href="<%= Url("Home_Land_AgencyProfile") %>">
                                            <img class="card-img-top" src="/Projects/Homes/Home_Land/Resources/img/agent.jpg" alt="Card image cap">
