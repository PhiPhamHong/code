<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_Land_Register.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_Land.Pages.Home_Land_Register" %>
                        ...
                        <form>
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="customControlAutosizing">I agree with all <a href="<%= Url("Home_Land_Terms") %>">Terms & Conditions</a></label>
                                </div>
                            </div>
