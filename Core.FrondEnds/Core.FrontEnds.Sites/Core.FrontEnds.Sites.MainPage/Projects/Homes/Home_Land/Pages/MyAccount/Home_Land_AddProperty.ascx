<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_Land_AddProperty.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_Land.Pages.MyAccount.Home_Land_AddProperty" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active text-success" href="<%= Url("Home_Land_AddProperty") %>">Add Property</a>
                    </li>
                </ul>
            </div>
        </div>
