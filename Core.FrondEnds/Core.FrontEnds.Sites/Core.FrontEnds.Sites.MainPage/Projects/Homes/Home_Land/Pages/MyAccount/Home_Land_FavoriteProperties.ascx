<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Home_Land_FavoriteProperties.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Homes.Home_Land.Pages.MyAccount.Home_Land_FavoriteProperties" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <ul class="nav justify-content-center">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="<%= Url("Home_Land_MyProperties") %>">My Properties</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link active text-primary" href="<%= Url("Home_Land_FavoriteProperties") %>">Favorite Properties</a>
                    </li>
                    <li class="nav-item">
