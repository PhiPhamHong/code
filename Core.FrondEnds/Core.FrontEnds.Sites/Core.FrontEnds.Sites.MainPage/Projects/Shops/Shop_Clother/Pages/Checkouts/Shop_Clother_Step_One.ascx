<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Clother_Step_One.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Clother.Pages.Checkouts.Shop_Clother_Step_One" %>
            ...
            <div class="col-lg-8 col-md-8 mx-auto">
                <div class="widget">
                    <div class="section-header section-header-center text-center">
                        <h3 class="heading-design-center-h3">Please fill up your Shipping details
                        </h3>
                    </div>
                    ...
                    <form>
                        ...
                        <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                            ...
                            <span class="custom-control-description">Use my delivery address as my billing address
                            </span>
                        </label>
                        <a href="<%= Url("Shop_Clother_Step_Two") %>" class="btn btn-theme-round btn-lg pull-right">NEXT</a>
                    </form>
                </div>
            </div>
        </div>
