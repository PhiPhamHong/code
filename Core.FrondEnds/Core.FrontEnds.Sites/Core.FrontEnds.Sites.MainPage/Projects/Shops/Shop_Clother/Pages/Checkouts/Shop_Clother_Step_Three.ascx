<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Clother_Step_Three.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Clother.Pages.Checkouts.Shop_Clother_Step_Three" %>
            ...
            <div class="col-lg-8 col-md-8 mx-auto">
                <div class="widget">
                    <div class="section-header section-header-center text-center">
                        <h3 class="heading-design-center-h3">Select a payment method
                        </h3>
                    </div>
                    <form class="col-lg-8 col-md-8 mx-auto">
                        ...
                        <a href="<%= Url("Shop_Clother_Done") %>" class="btn btn-theme-round btn-lg pull-right">NEXT</a>
                    </form>
                </div>
            </div>
        </div>
