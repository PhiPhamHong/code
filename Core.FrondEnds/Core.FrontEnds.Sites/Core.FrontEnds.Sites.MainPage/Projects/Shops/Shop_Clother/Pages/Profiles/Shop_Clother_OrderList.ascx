<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Clother_OrderList.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Clother.Pages.Profiles.Shop_Clother_OrderList" %>
                        ...
                        <table class="datatabel table table-striped table-bordered order-list-tabel table-responsive" width="100%" cellspacing="0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>$760.50</td>
                                    <td><a data-toggle="tooltip" data-placement="top" title="" href="<%= Url("Shop_Clother_ProductDetails") %>" data-original-title="View Detail" class="btn btn-theme-round btn-sm"><i class="icofont icofont-eye-alt"></i></a></td>
                                </tr>
                                <tr>
                                    <td>#258</td>
                                    <td>July 21, 2017</td>
