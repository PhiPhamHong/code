<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Clother_Profile.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Clother.Pages.Profiles.Shop_Clother_Profile" %>
