<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Clother_WishList.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Clother.Pages.Profiles.Shop_Clother_WishList" %>
               ...
               <div class="col-lg-4 col-md-4 col-sm-5">
                  <div class="user-account-sidebar">
                     <aside class="user-info-wrapper">
                        ...
                        <div class="user-info">
                           <div class="user-avatar"><a class="edit-avatar" href=""><i class="icofont icofont-edit"></i></a><img src="/Projects/Shops/Shop_Clother/Resources/images/user-ava.jpg" alt="User"></div>
                           <div class="user-data">
                              <h4>Osahan Singh</h4>
                     ...
                     <nav class="list-group">
                        ...
                        <a class="list-group-item" href="<%= Url("Shop_Clother_Address") %>"><i class="icofont icofont-location-pin fa-fw"></i> My Address</a>
                        <a class="list-group-item active justify-content-between" href="<%= Url("Shop_Clother_WishList") %>"><span><i class="icofont icofont-heart-alt fa-fw"></i> Wish List</span> <span class="badge badge-danger"> 35 Items</span></a>
                           ...
                           <div class="h-100">
                              <div class="product-item">
                                 <div class="product-item-image">
                                    ...
                                    <a href="<%= Url("Shop_Clother_ProductDetails") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Clother/Resources/images/men/small/2.jpg" alt=""></a>
                                 </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="h-100">
                              <div class="product-item">
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-close-circled"></i></a></span>
                                    <a href="<%= Url("Shop_Clother_ProductDetails") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Clother/Resources/images/all-products/small/1.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <h4 class="card-title"><a href="<%= Url("Shop_Clother_ProductDetails") %>">Ipsums Dolors Untra</a></h4>
                                    <h5>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="h-100">
                              <div class="product-item">
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-close-circled"></i></a></span>
                                    <a href="<%= Url("Shop_Clother_ProductDetails") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Clother/Resources/images/all-products/small/4.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <h4 class="card-title"><a href="<%= Url("Shop_Clother_ProductDetails") %>">Ipsums Dolors Untra</a></h4>
                                    <h5>
                        ...
                        <div class="col-lg-4 col-md-6">
                           <div class="h-100">
                              <div class="product-item">
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-close-circled"></i></a></span>
                                    <a href="<%= Url("Shop_Clother_ProductDetails") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Clother/Resources/images/women/small/3.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <h4 class="card-title"><a href="<%= Url("Shop_Clother_ProductDetails") %>">Ipsums Dolors Untra</a></h4>
                                    <h5>
