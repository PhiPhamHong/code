<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Clother_Contact.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Clother.Pages.Shop_Clother_Contact" %>
