<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Clother_FAQ.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Clother.Pages.Shop_Clother_FAQ" %>
...
<section class="faq-page">
    <div class="container">
        <div class="section-header section-header-center text-center">
            <h3 class="heading-design-center-h3">Frequently asked questions (FAQ)
            </h3>
