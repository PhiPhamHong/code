<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Clother_Login.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Clother.Pages.Shop_Clother_Login" %>
                    ...
                    <div class="login-modal-right">
                        ...
                        <div class="text-center login-footer-tab">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" href="<%= Url("Shop_Clother_HomeLogin") %>""><i class="icofont icofont-lock"></i>LOGIN</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="<%= Url("Shop_Clother_Register") %>"><i class="icofont icofont-pencil-alt-5"></i>REGISTER</a>
                                </li>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
