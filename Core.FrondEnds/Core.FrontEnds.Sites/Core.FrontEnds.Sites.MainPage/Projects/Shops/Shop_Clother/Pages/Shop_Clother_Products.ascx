<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Clother_Products.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Clother.Pages.Shop_Clother_Products" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-md-4">
                ...
                <hr>
                <a href="<%= Url("Shop_Clother_Products") %>">
                    <img class="rounded" src="/Projects/Shops/Shop_Clother/Resources/images/women-top.png" alt="Bannar 1">
                </a>
            </div>
            <div class="col-lg-9 col-md-8">
                <div class="osahan-inner-slider" data-control-load="innerSlider">
                    <div class="owl-carousel owl-carousel-slider">
                        <div class="item">
                            <a href="">
                                <img class="d-block img-fluid" src="/Projects/Shops/Shop_Clother/Resources/images/grid-slider/slider1.jpg" alt="First slide"></a>
                        </div>
                        <div class="item">
                            <a href="">
                                <img class="d-block img-fluid" src="/Projects/Shops/Shop_Clother/Resources/images/grid-slider/slider2.jpg" alt="First slide"></a>
                        </div>
                        <div class="item">
                            <a href="">
                                <img class="d-block img-fluid" src="/Projects/Shops/Shop_Clother/Resources/images/grid-slider/slider3.jpg" alt="First slide"></a>
                        </div>
                    </div>
                </div>
                <div class="osahan_products_top_filter row">
                    ...
                    <div class="col-lg-6 col-md-6 sort-by-btn pull-right">
                        <div class="view-mode pull-right">
                            <a class="active" href="<%= Url("Shop_Clother_Products") %>"><i class="fa fa-th-large"></i></a><a href="shop-list-left-sidebar.html"><i class="fa fa-th-list"></i></a>
                        </div>
