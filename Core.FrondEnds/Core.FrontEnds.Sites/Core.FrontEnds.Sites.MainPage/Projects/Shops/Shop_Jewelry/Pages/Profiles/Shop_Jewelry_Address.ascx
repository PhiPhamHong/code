<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Jewelry_Address.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Jewelry.Pages.Profiles.Shop_Jewelry_Address" %>
<section class="section-padding bg-dark inner-header">
    <div class="container">
        <div class="row">
            <div class="col-md-12 text-center">
                <h1 class="mt-0 mb-3 text-white">My Address</h1>
                <div class="breadcrumbs">
                    <p class="mb-0 text-white"><a href="<%= Url("Shop_Jewelry") %>" class="text-white">Home</a>  /  <span class="text-success">My Address</span></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card account-left">
                            ...
                            <div class="list-group">
                                ...
                                <a href="<%= Url("Shop_Jewelry_Address") %>" class="list-group-item list-group-item-action active"><i aria-hidden="true" class="mdi mdi-map-marker-circle"></i>My Address</a>
                        ...
                        <div class="card card-body account-right">
                            <div class="widget">
                                <div class="section-header">
                                    <h5 class="heading-design-h5">Contact Address
                                    </h5>
                                </div>
                                <form>
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control border-form-control" value="Team Company Ltd." placeholder="" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control border-form-control" value="" placeholder="Phone number" type="number">
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-right">
                                            ...
                                            <button type="button" class="btn btn-info btn-lg">Update Address </button>
                                        </div>
                                    </div>
                                </form>
                            </div>
