<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Jewelry_Profile.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Jewelry.Pages.Profiles.Shop_Jewelry_Profile" %>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="breadcrumbs">
                    <p class="mb-0 text-white"><a href="<%= Url("Shop_Jewelry") %>" class="text-white">Home</a>  /  <span class="text-success">My Profile</span></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-md-4">
                        <div class="card account-left">
                            <div class="user-profile-header">
                                ...
                                <p>+91 8568079956</p>
                                <p>teamdesign@gmail.com</p>
                            </div>
                            <div class="list-group">
                                <a href="<%= Url("Shop_Jewelry_Profile") %>" class="list-group-item list-group-item-action active"><i aria-hidden="true" class="mdi mdi-account-outline"></i>My Profile</a>
