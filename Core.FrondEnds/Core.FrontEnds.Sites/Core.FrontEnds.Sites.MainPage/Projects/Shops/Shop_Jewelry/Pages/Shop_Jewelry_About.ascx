<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Jewelry_About.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Jewelry.Pages.Shop_Jewelry_About" %>
...
<!-- Inner Header -->
            ...
            <div class="row">
               <div class="col-md-12 text-center">
                  ...
                  <div class="breadcrumbs">
                     <p class="mb-0 text-white"><a class="text-white" href="<%= Url("Shop_Jewelry") %>">Home</a>  /  <span class="text-success">About Us</span></p>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row">
               <div class="pl-4 col-lg-5 col-md-5 pr-4">
                  <img class="rounded img-fluid" src="/Projects/Shops/Shop_Jewelry/Resources/img/about.jpg" alt="Card image cap">
               </div>
               <div class="col-lg-6 col-md-6 pl-5 pr-5">
                  <h2 class="mt-5 mb-5 text-secondary">It is a long established fact that a reader will be distracted by the readable content.</h2>
      ...
      <!-- End About -->
      <!-- What We Provide -->
      <section class="section-padding box-provide">
            ...
            <div class="row">
               <div class="col-lg-4 col-md-4">
                  <div class="team-card text-center">
                     <img class="img-fluid mb-4" src="/Projects/Shops/Shop_Jewelry/Resources/img/user/1.jpg" alt="">
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="team-card text-center">
                     <img class="img-fluid mb-4" src="/Projects/Shops/Shop_Jewelry/Resources/img/user/2.jpg" alt="">
                     <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
               ...
               <div class="col-lg-4 col-md-4">
                  <div class="team-card text-center">
                     <img class="img-fluid mb-4" src="/Projects/Shops/Shop_Jewelry/Resources/img/user/3.jpg" alt="">
                     <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
