<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Jewelry_Cart.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Jewelry.Pages.Shop_Jewelry_Cart" %>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="breadcrumbs">
                    <p class="mb-0 text-white"><a href="<%= Url("Shop_Jewelry") %>" class="text-white">Home</a>  /  <span class="text-success">Cart</span></p>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="card card-body cart-table">
                    <div class="table-responsive">
                        <table class="table cart_summary">
                            ...
                            <tbody>
                                <tr>
                                    <td class="cart_product"><a href="<%= Url("Shop_Jewelry_Single") %>">
                                        <img class="img-fluid" src="/Projects/Shops/Shop_Jewelry/Resources/img/item/11.jpg" alt=""></a></td>
                                    <td class="cart_description">
                                        <h5 class="product-name"><a href="<%= Url("Shop_Jewelry_Single") %>">Ipsums Dolors Untra </a></h5>
                                ...
                                <tr>
                                    <td class="cart_product"><a href="<%= Url("Shop_Jewelry_Single") %>">
                                        <img alt="Product" src="/Projects/Shops/Shop_Jewelry/Resources/img/item/10.jpg" class="img-fluid"></a></td>
                                    <td class="cart_description">
                                        <h5 class="product-name"><a href="<%= Url("Shop_Jewelry_Single") %>">Ipsums Dolors Untra </a></h5>
                                        <h6><strong><span class="mdi mdi-approval"></span>Diamond</strong> - 18Kt Gold</h6>
                                    </td>
                                ...
                                <tr>
                                    <td class="cart_product"><a href="<%= Url("Shop_Jewelry_Single") %>">
                                        <img alt="Product" src="/Projects/Shops/Shop_Jewelry/Resources/img/item/9.jpg" class="img-fluid"></a></td>
                                    <td class="cart_description">
                                        <h5 class="product-name"><a href="<%= Url("Shop_Jewelry_Single") %>">Ipsums Dolors Untra </a></h5>
                                        <h6><strong><span class="mdi mdi-approval"></span>Diamond</strong> - 18Kt Gold</h6>
                                    </td>
                    ...
                    <a href="<%= Url("Shop_Jewelry_Checkout") %>">
