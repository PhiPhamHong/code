<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Jewelry_Checkout.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Jewelry.Pages.Shop_Jewelry_Checkout" %>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="breadcrumbs">
                    <p class="mb-0 text-white"><a href="<%= Url("Shop_Jewelry") %>" class="text-white">Home</a>  /  <span class="text-success">Checkout</span></p>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control border-form-control" value="" placeholder="First name" type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Last Name <span class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="" placeholder="Last name" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control border-form-control " value="" placeholder="teamdesign@gmail.com" disabled="" type="email">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control border-form-control"></textarea>
                                                    <small class="text-danger">Please include landmark (e.g : Opposite Bank) as the carrier service may find it easier to locate your address.
                                                    </small>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="text-center">
                                            <a href="<%= Url("Shop_Jewelry_Shop") %>">
                                                <button type="submit" class="btn btn-secondary mb-2 btn-lg">Return to store</button></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body pt-0 pr-0 pl-0 pb-0">
                        <div class="cart-list-product">
                            <a class="float-right remove-cart" href="<%= Url("Shop_Jewelry_Single") %>"><i class="mdi mdi-close"></i></a>
                            <img class="img-fluid" src="/Projects/Shops/Shop_Jewelry/Resources/img/item/11.jpg" alt="">
                            <span class="badge badge-success">50% OFF</span>
                            <h5><a href="<%= Url("Shop_Jewelry_Single") %>">Product Title Here</a></h5>
