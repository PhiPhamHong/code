<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Jewelry_Faq.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Jewelry.Pages.Shop_Jewelry_Faq" %>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div class="breadcrumbs">
                    <p class="mb-0 text-white"><a href="<%= Url("Shop_Jewelry") %>" class="text-white">Home</a>  /  <span class="text-success">FAQ</span></p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="card card-body">
                            <div class="section-header">
                                <h5 class="heading-design-h5">Ask us question
                                </h5>
                            </div>
                            <form>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-right">
                                        ...
                                        <button type="button" class="btn btn-info btn-lg">Send Message </button>
                                    </div>
                                </div>
                            </form>
                        </div>
