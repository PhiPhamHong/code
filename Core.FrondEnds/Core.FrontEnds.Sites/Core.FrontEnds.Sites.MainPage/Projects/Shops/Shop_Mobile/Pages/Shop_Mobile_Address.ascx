<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Address.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Pages.Shop_Mobile_Address" %>
            ...
            <div class="col-lg-4 col-md-4 col-sm-5">
                <div class="user-account-sidebar">
                    <aside class="user-info-wrapper">
                        ...
                        <div class="user-info">
                            <div class="user-avatar">
                                <a class="edit-avatar" href=""><i class="icofont icofont-edit"></i></a>
                                <img src="/Projects/Shops/Shop_Mobile/Resources/images/user-ava.jpg" alt="User">
                            </div>
                            <div class="user-data">
                                <h4>Osahan Singh</h4>
                    ...
                    <nav class="list-group">
                        ...
                        <a class="list-group-item active" href="<%= Url("Shop_Mobile_Address") %>"><i class="icofont icofont-location-pin fa-fw"></i>My Address</a>
                        ...
                        <div class="row mb-3">
                            <div class="col-sm-12">
                                <label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                    ...
                                    <span class="custom-control-description">Same as Contact Address  </span>
                                </label>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-12 text-right">
                                ...
                                <button type="button" class="btn btn-outline-success btn-lg">Update Address </button>
                            </div>
                        </div>
                    </form>
                </div>
