<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Blog_left.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Pages.Shop_Mobile_Blog_left" %>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Blog Left</li>
                </ol>
            </div>
        </div>
    </div>
            ...
            <div class="col-md-3">
                <div class="widget blog-sidebar mb18">
                    ...
                    <div class="sidebar-widget">
                        <h5>Categories</h5>
                        <ul class="widget-tag">
                            <li><a href=""><i class="icofont icofont-square-right"></i>Photography</a></li>
                            <li><a href=""><i class="icofont icofont-square-right"></i>Web Design <span class="badge badge-primary">74</span></a></li>
                            <li><a href=""><i class="icofont icofont-square-right"></i>Lifestyle</a></li>
                            <li><a href=""><i class="icofont icofont-square-right"></i>Responsive <span class="badge badge-success">332</span></a></li>
                            <li><a href=""><i class="icofont icofont-square-right"></i>MultiPurpose Theme</a></li>
                            <li><a href=""><i class="icofont icofont-square-right"></i>Agency</a></li>
                            <li><a href=""><i class="icofont icofont-square-right"></i>Portfolio</a></li>
                        </ul>
                    </div>
                    <div class="sidebar-widget">
                        <h5>Top Posts</h5>
                        <ul class="widget-post">
                            <li>
                                <a href="<%= Url("Shop_Mobile_Blog_single") %>" class="widget-post-media">
                                    <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/blog-01.jpg" alt="alt">
                                </a>
                            ...
                            <li>
                                <a href="<%= Url("Shop_Mobile_Blog_single") %>" class="widget-post-media">
                                    <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/blog-02.jpg" alt="alt">
                                </a>
                                <div class="widget-post-info">
                            ...
                            <li>
                                <a href="<%= Url("Shop_Mobile_Blog_single") %>" class="widget-post-media">
                                    <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/blog-03.jpg" alt="alt">
                                </a>
                                <div class="widget-post-info">
                ...
                <div class="left-ad mt-2">
                    <img class="rounded img-fluid" src="http://via.placeholder.com/350x290" alt="">
                </div>
            </div>
            <div class="col-md-9">
                <div class="row">
                    <div class="col-md-4">
                        <div class="panel blog-box">
                            <div class="panel-heading">
                                <div class="media clearfix">
                                    <a class="pull-left">
                                        <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/user/a3.jpg" alt="profile-picture">
                                    </a>
                                    <div class="media-body">
                                        <small>Created by: <span class="font-bold">Mike Smith</span> </small>
                                        <br>
                                        <small class="text-muted">21.03.2019, 06:45 pm</small>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-image">
                                <img class="img-responsive" src="/Projects/Shops/Shop_Mobile/Resources/images/blog/blog-01.jpg" alt="">
                                <div class="title">
                                    <a href="<%= Url("Shop_Mobile_Blog_single") %>">
                            ...
                            <div class="panel-footer">
                                <span class="pull-right">
                                    <i class="fas fa-comments"></i>22 comments
                                </span>
                        ...
                        <div class="panel blog-box">
                            <div class="panel-heading">
                                <div class="media clearfix">
                                    <a class="pull-left">
                                        <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/user/a5.jpg" alt="profile-picture">
                                    </a>
                                    <div class="media-body">
                                        <small>Created by: <span class="font-bold">John Wilkins</span> </small>
                                        <br>
                                        <small class="text-muted">17.05.2019, 10:25 pm</small>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                ...
                                <p><a href="<%= Url("Shop_Mobile_Blog_single") %>" class="btn btn-primary btn-xs">Read more</a></p>
                            </div>
                            <div class="panel-footer">
                                <span class="pull-right">
                        ...
                        <div class="panel blog-box">
                            <div class="panel-heading">
                                <div class="media clearfix">
                                    <a class="pull-left">
                                        <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/user/a6.jpg" alt="profile-picture">
                                    </a>
                                    <div class="media-body">
                                        <small>Created by: <span class="font-bold">John Wilkins</span> </small>
                                        <br>
                                        <small class="text-muted">22.12.2019, 04:17 pm</small>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                                ...
                                <p>
                                    Aenean aliquet, nibh vitae auctor commodo, justo odio rutrum lorem, a suscipit massa justo at purus.
                                </p>
                                <p><a href="<%= Url("Shop_Mobile_Blog_single") %>" class="btn btn-primary btn-xs">Read more</a></p>
                            </div>
                            <div class="panel-footer">
                    ...
                    <div class="col-md-4">
                        <div class="panel blog-box">
                            <div class="panel-heading">
                                <div class="media clearfix">
                                    <a class="pull-left">
                                        <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/user/a1.jpg" alt="profile-picture">
                                    </a>
                                    <div class="media-body">
                                        <small>Created by: <span class="font-bold">Mark Word</span> </small>
                                        <br>
                                        <small class="text-muted">22.04.2019, 10:15 pm</small>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                        ...
                        <div class="panel blog-box">
                            <div class="panel-heading">
                                <div class="media clearfix">
                                    <a class="pull-left">
                                        <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/user/a7.jpg" alt="profile-picture">
                                    </a>
                                    <div class="media-body">
                                        <small>Created by: <span class="font-bold">Selena Jackson</span> </small>
                                        <br>
                                        <small class="text-muted">01.02.2019, 10:40 pm</small>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                        ...
                        <div class="panel blog-box">
                            <div class="panel-heading">
                                <div class="media clearfix">
                                    <a class="pull-left">
                                        <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/user/a4.jpg" alt="profile-picture">
                                    </a>
                                    <div class="media-body">
                                        <small>Created by: <span class="font-bold">Anna Smith</span> </small>
                                        <br>
                                        <small class="text-muted">10.07.2019, 02:12 am</small>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-image">
                            ...
                            <div class="panel-body">
                                ...
                                <p class="mb-4">
                                    Nam sollicitudin ornare tincidunt. Nulla sit amet urna vitae lectus.
                                </p>
                            </div>
                            <div class="panel-footer">
                                <span class="pull-right">
                    ...
                    <div class="col-md-4">
                        <div class="panel blog-box">
                            <div class="panel-heading">
                                <div class="media clearfix">
                                    <a class="pull-left">
                                        <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/user/a2.jpg" alt="profile-picture">
                                    </a>
                                    <div class="media-body">
                                        <small>Created by: <span class="font-bold">John Jackson</span> </small>
                                        <br>
                                        <small class="text-muted">11.10.2019, 11:46 pm</small>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-body">
                        ...
                        <div class="panel blog-box">
                            <div class="panel-heading">
                                <div class="media clearfix">
                                    <a class="pull-left">
                                        <img src="/Projects/Shops/Shop_Mobile/Resources/images/blog/user/a8.jpg" alt="profile-picture">
                                    </a>
                                    <div class="media-body">
                                        <small>Created by: <span class="font-bold">Selena Jackson</span> </small>
                                        <br>
                                        <small class="text-muted">16.02.2019, 08:34 pm</small>
                                    </div>
                                </div>
                            </div>
                            <div class="panel-image">
                                <img class="img-responsive" src="/Projects/Shops/Shop_Mobile/Resources/images/blog/blog-02.jpg" alt="">
                                <div class="title">
                                    <a href="<%= Url("Shop_Mobile_Blog_single") %>">
