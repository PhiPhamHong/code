<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Blog_single.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Pages.Shop_Mobile_Blog_single" %>
      ...
      <section class="blog_page">
         <div class="container">
            <div class="row">
               <div class="col-lg-8 col-md-8">
                  <div class="panel blog-box">
                     ...
                     <div class="panel-body">
                        ...
                        <p>Sed porta libero metus, nec feugiat enim pharetra vel. Sed vel sagittis augue. Donec hendrerit nibh ac dolor lobortis, eu varius odio sollicitudin. Proin non condimentum nulla, quis dictum leo. Vestibulum lobortis urna eu mauris viverra porttitor. Cras consequat leo condimentum lacus viverra sollicitudin. Donec dignissim ornare est, nec scelerisque purus mollis eu. Phasellus dictum suscipit ligula. Donec malesuada gravida velit. Nulla egestas diam in ligula mollis, nec tincidunt diam porta. Proin eleifend lacinia diam quis pretium. Sed lacinia varius nisi et euismod. Ut ac arcu vulputate, porta nibh non, ultricies erat. Nulla facilisi. </p>
                     </div>
                     <div class="entry-share">
                        <span class="text-muted">Share post:</span>
                        <div class="share-links">
                           <a class="social-button shape-circle sb-facebook" href="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Facebook"><i class="icofont icofont-social-facebook"></i></a>
                           <a class="social-button shape-circle sb-twitter" href="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Twitter"><i class="icofont icofont-social-twitter"></i></a>
                           <a class="social-button shape-circle sb-instagram" href="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Instagram"><i class="icofont icofont-social-instagram"></i></a>
                           <a class="social-button shape-circle sb-google-plus" href="" data-toggle="tooltip" data-placement="top" title="" data-original-title="Google +"><i class="icofont icofont-social-google-plus"></i></a>
                        </div>
                     </div>
                  ...
                  <div class="row">
                     <div class="col-sm-12">
                        <div class="widget reviews-section-comment blog-reviews mb18">
                           ...
                           <div class="row">
                              <div class="col-sm-12">
                                 <div class="review-block-title">
                                    <img class="review-block-image" src="/Projects/Shops/Shop_Mobile/Resources/images/users/1.jpg" alt="alt">
                                    <div class="review-block-name"><a href=""><i class="icofont icofont-ui-user"></i> Francis Burton</a> <span class="text-success"><i class="icofont icofont-check-circled"></i> Verified Buyer</span></div>
                           ...
                           <div class="row">
                              <div class="col-sm-12">
                                 <div class="review-block-title">
                                    <img class="review-block-image" src="/Projects/Shops/Shop_Mobile/Resources/images/users/2.jpg" alt="alt">
                           ...
                           <form>
                              ...
                              <div class="row">
                                 <div class="col-sm-12 text-right">
                                    ...
                                    <button type="button" class="btn btn-outline-success"> Post Comment </button>
                                 </div>
                              </div>
                           </form>
                        </div>
               ...
               <div class="col-md-4">
                  <div class="widget blog-sidebar mb18 mb-0">
                     <div class="sidebar-widget">
                        <div class="widget-search">
                           <div class="input-group">
                              <input class="form-control border-form-control" placeholder="Search Blog" type="text">
                              <span class="input-group-btn">
                              <button class="btn btn-theme-round" type="button"><i class="icofont icofont-search-alt-2"></i> Search</button>
                              </span>
                           </div>
                        </div>
                     </div>
