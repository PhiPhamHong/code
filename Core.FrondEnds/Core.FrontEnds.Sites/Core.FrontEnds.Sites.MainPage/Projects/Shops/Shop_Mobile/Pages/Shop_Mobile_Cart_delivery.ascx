<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Cart_delivery.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Pages.Shop_Mobile_Cart_delivery" %>
               ...
               <div class="col-lg-8 col-md-8 mx-auto">
                  <div class="widget">
                     ...
                     <form>
                        ...
                        <a href="<%= Url("Shop_Mobile_Cart_order") %>" class="btn btn-theme-round btn-lg pull-right">NEXT</a>
                     </form>
                  </div>
               </div>
            </div>
