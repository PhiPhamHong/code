<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Cart_order.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Pages.Shop_Mobile_Cart_order" %>
        ...
        <div class="row">
                            ...
                            <tbody>
                                <tr>
                                    <td class="cart_product"><a href="">
                                        <img class="img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products/small/3.jpg" alt="Product"></a></td>
                                ...
                                <tr>
                                    <td class="cart_product"><a href="">
                                        <img class="img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products/small/2.jpg" alt="Product"></a></td>
                                    <td class="cart_description">
                                        <p class="product-name"><a href="">Ipsums Dolors Untra </a></p>
                                ...
                                <tr>
                                    <td class="cart_product"><a href="">
                                        <img class="img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products/small/1.jpg" alt="Product"></a></td>
                                    <td class="cart_description">
                                        <p class="product-name"><a href="">Ipsums Dolors Untra </a></p>
            ...
            <div class="col-lg-4 col-md-4">
                ...
                <div class="left-ad mt-4">
                    <img class="rounded img-fluid" src="http://via.placeholder.com/350x203" alt="">
                </div>
            </div>
        </div>
    </div>
