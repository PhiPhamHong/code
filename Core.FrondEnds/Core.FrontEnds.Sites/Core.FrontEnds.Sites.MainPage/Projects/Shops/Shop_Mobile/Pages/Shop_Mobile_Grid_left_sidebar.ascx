<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Grid_left_sidebar.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Pages.Shop_Mobile_Grid_left_sidebar" %>
               ...
               <div class="col-lg-3 col-md-4">
                  <div class="widget">
                     <div class="category_sidebar">
                                    ...
                                    <div class="card-block">
                                       <ul class="trends">
                                          <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                             ...
                                             <span class="custom-control-description">Mobile <span class="item-numbers">155</span></span>
                                             </label>  
                                          </li>
                                          <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                             <input type="checkbox" class="custom-control-input">
                                             <span class="custom-control-indicator"></span>
                                             <span class="custom-control-description">Tab <span class="item-numbers">155</span></span>
                                             </label>  
                                          </li>
                                          <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                             <input type="checkbox" class="custom-control-input">
                                             <span class="custom-control-indicator"></span>
                                             <span class="custom-control-description">Watch <span class="badge badge-success">SALE</span><span class="item-numbers">155</span></span>
                                             </label>  
                                          </li>
                                          <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                             <input type="checkbox" class="custom-control-input" checked>
                                             <span class="custom-control-indicator"></span>
                                             <span class="custom-control-description">Head Phone <span class="item-numbers">155</span></span>
                                             </label>  
                                          </li>
                                          <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                             <input type="checkbox" class="custom-control-input">
                                             <span class="custom-control-indicator"></span>
                                             <span class="custom-control-description">Memory <span class="item-numbers">155</span></span>
                                             </label>  
                                          </li>
                                          <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                             <input type="checkbox" class="custom-control-input">
                                          ...
                                          <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                             <input type="checkbox" class="custom-control-input">
                                             <span class="custom-control-indicator"></span>
                                             <span class="custom-control-description">Watch <span class="badge badge-danger">NEW</span><span class="item-numbers">155</span></span>
                                             </label>  
                                          </li>
                                          <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                             <input type="checkbox" class="custom-control-input" checked>
                                 ...
                                 <div class="card-block">
                                    <ul class="trends">
                                       <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                          <input type="checkbox" class="custom-control-input">
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description">Brand Name <span class="item-numbers">569</span></span>
                                          </label>  
                                       </li>
                                       <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                          <input type="checkbox" class="custom-control-input" checked>
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description">Brand Name <span class="item-numbers">2911</span></span>
                                          </label>  
                                       </li>
                                       <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                          <input type="checkbox" class="custom-control-input">
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description">Brand Name <span class="item-numbers">2593</span></span>
                                          </label>  
                                       </li>
                                       <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                          <input type="checkbox" class="custom-control-input">
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description">Brand Name <span class="item-numbers">999</span></span>
                                          </label>  
                                       </li>
                                       <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                          <input type="checkbox" class="custom-control-input">
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description">Brand Name <span class="badge badge-warning">50% OFF</span> <span class="item-numbers">3000</span></span>
                                          </label>  
                                       </li>
                        ...
                        <aside class="sidebar_widget">
                           <div class="widget_title">
                              <h5 class="heading-design-h5">Ram</h5>
                           </div>
                           <div class="card">
                              <div class="collapse show">
                                 <div class="card-block">
                                    <ul class="trends">
                                       <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                          <input type="checkbox" class="custom-control-input" checked>
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description">Less than 512 MB <span class="item-numbers">203</span></span>
                                          </label>  
                                       </li>
                                       <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                          <input type="checkbox" class="custom-control-input">
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description">512 MB - 1 GB <span class="item-numbers">16</span></span>
                                          </label>  
                                       </li>
                                       <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                          <input type="checkbox" class="custom-control-input">
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description">1 GB <span class="item-numbers">84</span></span>
                                          </label>  
                                       </li>
                                       <li><label class="custom-control custom-checkbox mb-2 mr-sm-2 mb-sm-0">
                                          <input type="checkbox" class="custom-control-input">
                                          <span class="custom-control-indicator"></span>
                                          <span class="custom-control-description">2 GB <span class="item-numbers">95</span></span>
                                          </label>  
                                       </li>
                                    </ul>
                                 </div>
                  ...
                  <img class="rounded" src="/Projects/Shops/Shop_Mobile/Resources/images/menu2-top.png" alt="Bannar 1">
                  </a>
               </div>
               <div class="col-lg-9 col-md-8">
                  <div class="osahan-inner-slider">
                     <div class="owl-carousel owl-carousel-slider">
                        <div class="item">
                           <a href=""><img class="d-block img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/slider/slider1.jpg" alt="First slide"></a>
                        </div>
                        <div class="item">
                           <a href=""><img class="d-block img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/slider/slider2.jpg" alt="First slide"></a>
                        </div>
                        <div class="item">
                           <a href=""><img class="d-block img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/slider/slider3.jpg" alt="First slide"></a>
                        </div>
                     </div>
                  </div>
                  <div class="osahan_products_top_filter row">
                     <div class="col-lg-6 col-md-6 tags-action">
                        <span>4 GB RAM <a href=""><i class="icofont icofont-close-line-circled"></i></a></span>
                        <span>5.5 Inch <a href=""><i class="icofont icofont-close-line-circled"></i></a></span>
                        <span>128 GB <a href=""><i class="icofont icofont-close-line-circled"></i></a></span>
                     </div>
                     <div class="col-lg-6 col-md-6 sort-by-btn pull-right">
                        <div class="view-mode pull-right">
                           <a class="active" href="<%= Url("Shop_Mobile_Grid_left_sidebar") %>"> <i class="fa fa-th-large"></i> </a><a href="<%= Url("Shop_Mobile_Grid_left_sidebar") %>"> <i class="fa fa-th-list"></i> </a>
                        </div>
                           ...
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    ...
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products-list/small/1.jpg" alt=""></a>
                                 </div>
                           ...
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    ...
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products-list/small/2.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
                        ...
                        <div class="item">
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-heart"></i></a></span>
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products-list/small/3.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
                        ...
                        <div class="item">
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-heart"></i></a></span>
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products-list/small/4.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
                        ...
                        <div class="item">
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-heart"></i></a></span>
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products-list/small/5.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
                        ...
                        <div class="item">
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-heart"></i></a></span>
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products/small/1.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
                        ...
                        <div class="item">
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    <span class="like-icon"><a class="active" href=""> <i class="icofont icofont-heart"></i></a></span>
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products/small/2.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
                        ...
                        <div class="item">
                           <div class="h-100">
                              <div class="product-item pro">
                                 ...
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-heart"></i></a></span>
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products/small/3.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
                        ...
                        <div class="item">
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-heart"></i></a></span>
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products/small/4.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
                        ...
                        <div class="item">
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-heart"></i></a></span>
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products/small/5.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
                        ...
                        <div class="item">
                           <div class="h-100">
                              <div class="product-item">
                                 ...
                                 <div class="product-item-image">
                                    <span class="like-icon"><a href=""> <i class="icofont icofont-heart"></i></a></span>
                                    <a href="<%= Url("Shop_Mobile_Shop_details") %>"><img class="card-img-top img-fluid" src="/Projects/Shops/Shop_Mobile/Resources/images/all-products/small/6.jpg" alt=""></a>
                                 </div>
                                 <div class="product-item-body">
                                    <div class="product-item-action">
                                       <a data-toggle="tooltip" data-placement="top" title="" class="btn btn-theme-round btn-sm" href="" data-original-title="Add To Cart"><i class="icofont icofont-shopping-cart"></i></a>
