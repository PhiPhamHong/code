<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Profile.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Pages.Shop_Mobile_Profile" %>
