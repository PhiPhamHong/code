<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Register.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Shop_Mobile_Register" %>
                     ...
                     <div class="login-modal-right">
                        ...
                        <div class="text-center login-footer-tab">
                           <ul class="nav nav-tabs" role="tablist">
                              <li class="nav-item">
                                 <a class="nav-link" href="<%= Url("Shop_Mobile_Login") %>"><i class="icofont icofont-lock"></i> LOGIN</a>
                              </li>
                              <li class="nav-item">
                                 <a class="nav-link active" href="<%= Url("Shop_Mobile_Register") %>"><i class="icofont icofont-pencil-alt-5"></i> REGISTER</a>
                              </li>
                           </ul>
                        </div>
                        <div class="clearfix"></div>
