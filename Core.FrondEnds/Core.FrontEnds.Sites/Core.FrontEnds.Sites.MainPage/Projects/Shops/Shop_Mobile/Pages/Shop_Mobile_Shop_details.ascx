<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Shop_details.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Pages.Shop_Mobile_Shop_details" %>
            ...
            <div class="row">
               <div class="col-sm-12">
                  <div class="widget reviews-section-comment mb18">
                     <div class="row">
                        <div class="col-sm-3">
                           <img class="review-block-image img-rounded" src="/Projects/Shops/Shop_Mobile/Resources/images/users/1.jpg" alt="alt">
                     ...
                     <div class="row">
                        <div class="col-sm-3">
                           <img class="review-block-image img-rounded" src="/Projects/Shops/Shop_Mobile/Resources/images/users/2.jpg" alt="alt">
                     ...
                     <div class="row">
                        <div class="col-sm-3">
                           <img class="review-block-image img-rounded" src="/Projects/Shops/Shop_Mobile/Resources/images/users/3.jpg" alt="alt">
