<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Shopping_cart.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Mobile.Pages.Shop_Mobile_Shopping_cart" %>
                  ...
                  <div class="widget">
                     ...
                     <div class="text-center">
                        <ul class="nav nav-tabs round-tabs" role="tablist">
                           <li class="nav-item">
                              <a class="nav-link active" data-toggle="tab" href="#ordertab" role="tab">Order</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link" data-toggle="tab" href="#checkouttab" role="tab">Checkout</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link" data-toggle="tab" href="#deliverytab" role="tab">Delivery</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link" data-toggle="tab" href="#donetab" role="tab">Done</a>
                           </li>
                        </ul>
                     </div>
                     <!-- Tab panes -->
                     <div class="tab-content">
                        <div class="tab-pane active" id="ordertab" role="tabpanel">
                           <div class="order-detail-content">
                                       ...
                                       <tr>
                                          ...
                                          <td class="qty">
                                             <div class="input-group">
                                                ...
                                                <input type="text" name="quant[1]" class="form-control border-form-control form-control-sm input-number" value="1">
                                                <span class="input-group-btn">
                              ...
                              <div class="cart_navigation">
                                 <a href="" class="btn btn-theme-round-outline pull-left"><i class="fa fa-arrow-left"></i> Continue shopping</a>
                                 <a href="" class="btn btn-theme-round pull-right"><i class="fa fa-check"></i> Proceed to checkout</a>
                              </div>
                           </div>
                        </div>
                        <div class="tab-pane" id="checkouttab" role="tabpanel">
                           <div class="order-detail-form">
                              ...
                              <div class="cart_navigation">
                                 <a href="" class="btn btn-theme-round-outline pull-left">Back to Order</a>
                                 <a href="" class="btn btn-theme-round pull-right">Pay $337.88</a>
                              </div>
                           </div>
                        </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control border-form-control " value="" placeholder="" type="text">
                                       </div>
                                    </div>
                                 </div>
                              </form>
                              <div class="cart_navigation">
                                 <a href="#delivery" class="btn btn-theme-round-outline pull-left">Back to Order</a>
                                 <a href="#done" class="btn btn-theme-round pull-right">Pay $337.88</a>
                              </div>
                           </div>
                        </div>
                        <div class="tab-pane" id="donetab" role="tabpanel">
                           <div class="order-detail-form text-center">
                              ...
                              <div class="cart_navigation text-center">
                                 <a href="" class="btn btn-theme-round-outline">Return to store</a>
                              </div>
                           </div>
                        </div>
                     </div>
