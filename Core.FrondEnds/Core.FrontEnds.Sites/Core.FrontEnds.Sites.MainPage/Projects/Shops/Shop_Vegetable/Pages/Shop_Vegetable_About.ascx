<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Vegetable_About.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Vegetable.Pages.Shop_Vegetable_About" %>
    ...
    <div class="container">
        <div class="row">
            <div class="pl-4 col-lg-5 col-md-5 pr-4">
                <img class="rounded img-fluid" src="/Projects/Shops/Shop_Vegetable/Resources/img/about.jpg" alt="Card image cap">
            </div>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="team-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Shops/Shop_Vegetable/Resources/img/user/1.jpg" alt="">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="team-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Shops/Shop_Vegetable/Resources/img/user/2.jpg" alt="">
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="team-card text-center">
                    <img class="img-fluid mb-4" src="/Projects/Shops/Shop_Vegetable/Resources/img/user/3.jpg" alt="">
                    <p class="mb-4">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been.</p>
