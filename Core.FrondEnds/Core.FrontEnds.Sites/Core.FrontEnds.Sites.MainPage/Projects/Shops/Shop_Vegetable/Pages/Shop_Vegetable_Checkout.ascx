<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Vegetable_Checkout.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Vegetable.Pages.Shop_Vegetable_Checkout" %>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control border-form-control" value="" placeholder="Tony" type="text">
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    <label class="control-label">Last Name <span class="required">*</span></label>
                                                    <input class="form-control border-form-control" value="" placeholder="Stark" type="text">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control border-form-control " value="" placeholder="team@gmail.com" disabled="" type="email">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
