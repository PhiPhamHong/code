<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Vegetable_Contact.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Vegetable.Pages.Shop_Vegetable_Contact" %>
