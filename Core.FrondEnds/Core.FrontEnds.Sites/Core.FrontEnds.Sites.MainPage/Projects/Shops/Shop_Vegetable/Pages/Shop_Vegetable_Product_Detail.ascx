<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Vegetable_Product_Detail.ascx.cs" Inherits="Core.FrontEnds.Sites.MainPage.Projects.Shops.Shop_Vegetable.Pages.Shop_Vegetable_Product_Detail" %>
                ...
                <div class="shop-detail-left">
                    <div class="shop-detail-slider">
                        ...
                        <div id="sync1" class="owl-carousel">
                            <div class="item">
                                <img alt="" src="/Projects/Shops/Shop_Vegetable/Resources/img/item/1.jpg" class="img-fluid img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Shops/Shop_Vegetable/Resources/img/item/2.jpg" class="img-fluid img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Shops/Shop_Vegetable/Resources/img/item/3.jpg" class="img-fluid img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Shops/Shop_Vegetable/Resources/img/item/4.jpg" class="img-fluid img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Shops/Shop_Vegetable/Resources/img/item/5.jpg" class="img-fluid img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Shops/Shop_Vegetable/Resources/img/item/6.jpg" class="img-fluid img-center"></div>
                        </div>
            ...
            <div class="col-md-6">
                <div class="shop-detail-right">
                    ...
                    <a href="<%= Url("Shop_Vegetable_Checkout") %>">
                        <button type="button" class="btn btn-secondary btn-lg"><i class="mdi mdi-cart-outline"></i>Add To Cart</button>
                    </a>
