<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_About.ascx.cs" Inherits="Core.FE.MobileShop.Projects.Web.Pages.Shop_Mobile_About" %>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="our-team widget">
                            <div class="team_img">
                                <img src="/Projects/Web/Resources/images/team/1.jpg" alt="alt">
                                <ul class="social">
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="our-team widget">
                            <div class="team_img">
                                <img src="/Projects/Web/Resources/images/team/2.jpg" alt="alt">
                                <ul class="social">
                                    <li><a href=""><i class="fab fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fab fa-twitter"></i></a></li>
                                    <li><a href=""><i class="fab fa-linkedin"></i></a></li>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="our-team widget">
                            <div class="team_img">
                                <img src="/Projects/Web/Resources/images/team/3.jpg" alt="alt">
                                <ul class="social">
                                    <li><a href=""><i class="fab fa-facebook"></i></a></li>
                                    <li><a href=""><i class="fab fa-twitter"></i></a></li>
                                    <li><a href=""><i class="fab fa-linkedin"></i></a></li>
