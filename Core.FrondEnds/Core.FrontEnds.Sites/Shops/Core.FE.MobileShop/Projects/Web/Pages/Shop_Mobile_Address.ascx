<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Address.ascx.cs" Inherits="Core.FE.MobileShop.Projects.Web.Pages.Shop_Mobile_Address" %>
                    ...
                    <aside class="user-info-wrapper">
                        ...
                        <div class="user-info">
                            <div class="user-avatar">
                                ...
                                <img src="/Projects/Web/Resources/images/user-ava.jpg" alt="User">
                            </div>
                            <div class="user-data">
                                <h4>Osahan Singh</h4>
