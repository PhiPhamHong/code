<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Category.ascx.cs" Inherits="Core.FE.MobileShop.Projects.Web.Pages.Shop_Mobile_Category" %>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-4 col-sm-4">
                  <div class="widget">
                     <div class="categories-page-image">
                        <img class="img-fluid" src="/Projects/Web/Resources/images/homepage3/men.png" alt="">
                     </div>
               ...
               <div class="col-lg-4 col-md-4 col-sm-4">
                  <div class="widget">
                     <div class="categories-page-image">
                        <img class="img-fluid" src="/Projects/Web/Resources/images/homepage3/kids.png" alt="">
                     </div>
                     <div class="widget-header">
               ...
               <div class="col-lg-4 col-md-4 col-sm-4">
                  <div class="widget">
                     <div class="categories-page-image">
                        <img class="img-fluid" src="/Projects/Web/Resources/images/homepage3/women.png" alt="">
                     </div>
                     <div class="widget-header">
                        <small>98,156 Items</small>
