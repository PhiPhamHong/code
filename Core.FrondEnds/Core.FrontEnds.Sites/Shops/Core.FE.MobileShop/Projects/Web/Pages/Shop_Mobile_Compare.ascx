<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Compare.ascx.cs" Inherits="Core.FE.MobileShop.Projects.Web.Pages.Shop_Mobile_Compare" %>
                        ...
                        <table class="table table-bordered table-compare">
                           <tbody>
                              <tr>
                                 ...
                                 <td style="width: 20%;"><a href=""><img class="img-thumbnail"  src="/Projects/Web/Resources/images/all-products-list/small/1.jpg" alt="Product" width="230"></a></td>
                                 <td style="width: 20%;"><a href=""><img class="img-thumbnail"  src="/Projects/Web/Resources/images/all-products-list/small/2.jpg" alt="Product" width="230"></a></td>
                                 <td style="width: 20%;"><a href=""><img class="img-thumbnail"  src="/Projects/Web/Resources/images/all-products-list/small/3.jpg" alt="Product" width="230"></a></td>
                                 <td style="width: 20%;"><a href=""><img class="img-thumbnail"  src="/Projects/Web/Resources/images/all-products-list/small/4.jpg" alt="Product" width="230"></a></td>
                              </tr>
                              <tr>
