<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Shop_Mobile_Grid_left_sidebar.ascx.cs" Inherits="Core.FE.MobileShop.Projects.Web.Pages.Shop_Mobile_Grid_left_sidebar" %>
    ...
    <div class="container">
        <div class="row">
            <%-- <div class="col-lg-3 col-md-4">
                  ...
                  <img class="rounded" src="/Projects/Web/Resources/images/menu2-top.png" alt="Bannar 1">
                  </a>
               </div>--%>
            <div class="col-lg-12 col-md-12">
                <%--<div class="osahan-inner-slider">
                     <div class="owl-carousel owl-carousel-slider">
                        <div class="item">
                           <a href=""><img class="d-block img-fluid" src="/Projects/Web/Resources/images/slider/slider1.jpg" alt="First slide"></a>
                        </div>
                        <div class="item">
                           <a href=""><img class="d-block img-fluid" src="/Projects/Web/Resources/images/slider/slider2.jpg" alt="First slide"></a>
                        </div>
                        <div class="item">
                           <a href=""><img class="d-block img-fluid" src="/Projects/Web/Resources/images/slider/slider3.jpg" alt="First slide"></a>
                        </div>
                     </div>
                  </div>--%>
