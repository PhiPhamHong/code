...
$(function ()
{
    ...
    var runPageLoad = function (query, content, page)
    {
        ...
        var page0 = "ViSon." + query.UrlEngine;
        ...
        var js = "try { currentPageLoad = new " + page1 + "(); } catch(ex) { try { currentPageLoad = new " + page0 + "(); } catch(ex) { currentPageLoad = ViSon.DefaultPageLoadInstance(); } }";
        eval(js);
