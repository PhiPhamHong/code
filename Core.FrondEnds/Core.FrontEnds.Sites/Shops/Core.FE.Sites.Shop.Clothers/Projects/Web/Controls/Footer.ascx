<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Footer.ascx.cs" Inherits="Core.FE.Sites.Shop.Clothers.Projects.Web.Controls.Footer" %>
<footer>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                ...
                <div class="footer-links">
                    <ul>
                        ...
                        <li><a href="<%= Url("Home") %>">New Collection</a></li>
                        <li><a href="<%= Url("Home") %>">Mens Collection</a></li>
                        <li><a href="<%= Url("Home") %>">Women Dresses</a></li>
                        <li><a href="<%= Url("Home") %>">Kids Collection</a></li>
                    </ul>
                </div>
                <div class="copyright">
                    <p>
                        © Copyright 2018 Team Design.&nbsp; | &nbsp; Made with <i class="fa fa-heart"></i>
                        by
                        <a target="_blank" href="http://teamdesign.info">
                            <strong>Team Design</strong>
                        </a>
                    </p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 text-right">
                <strong>Tải App &nbsp; </strong>
                <a href="">
                    <img alt="" src="/Projects/Web/Resources/images/app-store.png"></a>
                <a href="">
                    <img alt="" src="/Projects/Web/Resources/images/google-play.png"></a>
            </div>
        </div>
    </div>
</section>
