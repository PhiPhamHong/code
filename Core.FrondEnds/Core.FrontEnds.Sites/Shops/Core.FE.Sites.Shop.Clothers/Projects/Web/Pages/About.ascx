<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="About.ascx.cs" Inherits="Core.FE.Sites.Shop.Clothers.Projects.Web.Pages.About" %>
                  ...
                  <div class="row">
                     <div class="col-lg-4 col-md-4">
                        <div class="our-team widget">
                           <div class="team_img">
                              <img src="/Projects/Web/Resources/images/men/small/2.jpg">
                              <ul class="social">
                     ...
                     <div class="col-lg-4 col-md-4">
                        <div class="our-team widget">
                           <div class="team_img">
                              <img src="/Projects/Web/Resources/images/men/small/1.jpg">
                              <ul class="social">
                                 <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                 <li><a href=""><i class="fa fa-twitter"></i></a></li>
                                 <li><a href=""><i class="fa fa-linkedin"></i></a></li>
                     ...
                     <div class="col-lg-4 col-md-4">
                        <div class="our-team widget">
                           <div class="team_img">
                              <img src="/Projects/Web/Resources/images/men/small/4.jpg">
                              <ul class="social">
                                 <li><a href=""><i class="fa fa-facebook"></i></a></li>
                                 <li><a href=""><i class="fa fa-twitter"></i></a></li>
                                 <li><a href=""><i class="fa fa-linkedin"></i></a></li>
