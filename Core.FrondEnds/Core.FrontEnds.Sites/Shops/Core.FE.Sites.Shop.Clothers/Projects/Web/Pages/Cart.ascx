<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Cart.ascx.cs" Inherits="Core.FE.Sites.Shop.Clothers.Projects.Web.Pages.Cart" %>
                ...
                <div class="widget">
                    ...
                    <div class="order-detail-content">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="cart_product"><a href="">
                                            <img class="img-fluid" src="/Projects/Web/Resources/images/all-products/small/3.jpg" alt="Product"></a></td>
                                    ...
                                    <tr>
                                        <td class="cart_product"><a href="">
                                            <img class="img-fluid" src="/Projects/Web/Resources/images/all-products/small/2.jpg" alt="Product"></a></td>
                                        <td class="cart_description">
                                            <p class="product-name"><a href="">Ipsums Dolors Untra </a></p>
                                    ...
                                    <tr>
                                        <td class="cart_product"><a href="">
                                            <img class="img-fluid" src="/Projects/Web/Resources/images/all-products/small/1.jpg" alt="Product"></a></td>
                                        <td class="cart_description">
                                            <p class="product-name"><a href="">Ipsums Dolors Untra </a></p>
                        ...
                        <div class="cart_navigation">
                            <a href="" class="btn btn-theme-round-outline pull-left" href="<%= Url("Products") %>"><i class="fa fa-arrow-left"></i> Continue shopping </a>
                            <a href="" class="btn btn-theme-round pull-right" href="<%= Url("Step_One") %>"><i class="fa fa-check"></i> Proceed to checkout </a>
                        </div>
                    </div>
                </div>
            </div>
