<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Step_One.ascx.cs" Inherits="Core.FE.Sites.Shop.Clothers.Projects.Web.Pages.Checkouts.Step_One" %>
            ...
            <div class="col-lg-8 col-md-8 mx-auto">
                <div class="widget">
                    ...
                    <form>
                        ...
                        <a href="<%= Url("Step_Two") %>" class="btn btn-theme-round btn-lg pull-right">NEXT</a>
                    </form>
                </div>
            </div>
        </div>
