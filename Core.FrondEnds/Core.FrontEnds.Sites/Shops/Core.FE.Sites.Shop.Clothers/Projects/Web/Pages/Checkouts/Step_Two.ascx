<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Step_Two.ascx.cs" Inherits="Core.FE.Sites.Shop.Clothers.Projects.Web.Pages.Checkouts.Step_Two" %>
        ...
        <div class="row">
            ...
            <div class="col-lg-8 col-md-8">
                <div class="widget">
                    ...
                    <a href="<%= Url("Step_Three") %>" class="btn btn-theme-round btn-lg pull-right">NEXT</a>
                </div>
            </div>
