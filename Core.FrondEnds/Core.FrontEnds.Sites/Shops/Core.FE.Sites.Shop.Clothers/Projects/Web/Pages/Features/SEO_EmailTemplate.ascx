<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SEO_EmailTemplate.ascx.cs" Inherits="Core.FE.Sites.Shop.Clothers.Projects.Web.Pages.Features.SEO_EmailTemplate" %>
