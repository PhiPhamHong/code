<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Login.ascx.cs" Inherits="Core.FE.Sites.Shop.Clothers.Projects.Web.Pages.Login" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<%= Url("Home") %>"><i class="icofont icofont-ui-home"></i>Home</a></li>
                    ...
                    <div class="login-modal-right">
                        ...
                        <div class="text-center login-footer-tab">
                            <ul class="nav nav-tabs" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link" href="<%= Url("HomeLogin") %>""><i class="icofont icofont-lock"></i>LOGIN</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link active" href="<%= Url("Register") %>"><i class="icofont icofont-pencil-alt-5"></i>REGISTER</a>
                                </li>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
