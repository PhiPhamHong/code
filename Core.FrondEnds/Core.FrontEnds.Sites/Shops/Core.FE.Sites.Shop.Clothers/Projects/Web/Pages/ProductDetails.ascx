<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductDetails.ascx.cs" Inherits="Core.FE.Sites.Shop.Clothers.Projects.Web.Pages.ProductDetails" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-5">
                <div class="shop-detail-left" data-control-load="detailSlider">
                    <div class="item-img-grid">
                        ...
                        <div id="sync1" class="owl-carousel">
                            <div class="item">
                                <img alt="" src="/Projects/Web/Resources/images/women/large/product1.jpg" class="img-responsive img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Web/Resources/images/women/large/product2.jpg" class="img-responsive img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Web/Resources/images/women/large/product3.jpg" class="img-responsive img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Web/Resources/images/women/large/product4.jpg" class="img-responsive img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Web/Resources/images/women/large/product5.jpg" class="img-responsive img-center"></div>
                            <div class="item">
                                <img alt="" src="/Projects/Web/Resources/images/women/large/product6.jpg" class="img-responsive img-center"></div>
                        </div>
                    ...
                    <div class="widget">
                        ...
                        <div class="short-description">
                           ...
                           <p class="pull-right">Availability: <span class="badge badge-success">In Stock</span></p>
                            ...
                            <p>
                                <b>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</b> Nam fringilla augue nec est tristique auctor. Donec non est at libero vulputate rutrum.
                            </p>
                        ...
                        <div class="product-cart-option">
                            <ul class="list-inline">
                                <li class="list-inline-item"><a href=""><i class="icofont icofont-heart"></i><span>Add to Wishlist</span></a></li>
...
<section class="reviews-section">
    <div class="container">
        <div class="section-header">
            <h5 class="heading-design-h5">Ratings & Reviews  
            </h5>
        </div>
        <div class="row">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="widget reviews-section-comment mb18">
                    <div class="row">
                        <div class="col-sm-3">
                            <img class="review-block-image" src="/Projects/Web/Resources/images/men/small/1.jpg" class="img-rounded">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <img class="review-block-image" src="/Projects/Web/Resources/images/men/small/2.jpg" class="img-rounded">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <img class="review-block-image" src="/Projects/Web/Resources/images/men/small/3.jpg" class="img-rounded">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <img class="review-block-image" src="/Projects/Web/Resources/images/men/small/4.jpg" class="img-rounded">
                            <div class="review-block-name"><a href=""><i class="icofont icofont-ui-user"></i>Jon Smith</a></div>
                            <div class="review-block-date"><i class="icofont icofont-ui-calendar"></i>June 16, 2018 | 5 Day ago</div>
                        </div>
                        <div class="col-sm-9">
...
<section class="deals-of-the-day">
    <div class="container">
        <div class="section-header">
            <h5 class="heading-design-h5">Sản phẩm có liên quan
            </h5>
        </div>
        <div class="row">
