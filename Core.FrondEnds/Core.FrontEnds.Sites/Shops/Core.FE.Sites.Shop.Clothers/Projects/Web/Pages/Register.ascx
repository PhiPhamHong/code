<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Register.ascx.cs" Inherits="Core.FE.Sites.Shop.Clothers.Projects.Web.Pages.Register" %>
                    ...
                    <div class="login-modal-right">
                        ...
                        <div class="text-center login-footer-tab">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" href="<%= Url("Login") %>""><i class="icofont icofont-pencil-alt-5"></i>REGISTER</a>
                                </li>
                            </ul>
                        </div>
                        <div class="clearfix"></div>
