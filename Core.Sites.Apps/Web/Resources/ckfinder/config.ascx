...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        switch(PortalContext.Session.IAccountInfo.SessionType)
        {
            case Core.Business.Enums.SessionType.Account: BaseUrl = "/Web/Resources/Uploaded/" + PortalContext.CurrentUser.GetCurrentCompanyId() + "/"; break;
                //case Core.Business.Enums.SessionType.Partner: BaseUrl = "/Web/Resources/Uploaded/" + PortalContext.CurrentUser.GetCurrentCompanyId() + "-" + PortalContext.CurrentUser.CurrentPartner.PartnerId + "/"; break;
        }
        ...
        AccessControlProvider.Create(Request.QueryString["acl"]).BuildAccessControl(acl);
        //acl.FolderView = true;
        ...
        type.MaxSize = 0;
        type.AllowedExtensions = new string[] { "doc", "docx", "xls", "xlsx", "ppt", "pptx", "pdf","rar" };
        type.DeniedExtensions = new string[] { };
    }
