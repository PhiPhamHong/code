                    ...
                    (p.panel.each(function() {
                        ...
                        if (!c.parent().attr("role")) {
                            !0 === p.o.sortable &&
                                ...
                                (t = !0 === p.o.closeButton && l.data("panel-close") === m ?
                                ...
                                (e = !0 === p.o.fullscreenButton &&
                                    ...
                                    ""),
                                (n = !0 === p.o.collapseButton && l.data("panel-collapsed") === m ?
                                    ...
                                    ""),
                                (i = !0 === p.o.lockedButton && l.data("panel-locked") === m ?
                                ...
                                (o = ""),
                                (r = !0 === p.o.colorButton && l.data("panel-color") === m ?
                                    ...
                                    "</div>\t\t\t\t\t\t\t\t\t\t</div>" :
                                    ""),
                                (s = !0 === p.o.resetButton && l.data("panel-reset") === m ?
                                    ...
                                    "</span></a>" :
                                    ""),
                                (a = !0 === p.o.customButton && l.data("panel-custombutton") === m ?
                ...
                window.initApp.playSound("media/sound", "messagebox"),
                    ...
                    bootbox.confirm({
                        title: "<i class='fal fa-times-circle text-danger mr-2'></i> Do you wish to delete panel <span class='fw-500'>&nbsp;'" +
                            i +
                            "'&nbsp;</span>?",
                        message: "<span><strong>Cảnh báo:</strong> Panel này sẽ bị xóa khỏi khung nhìn của bạn!</span>",
                        centerVertical: !0,
                        swapButtonOrder: !0,
                        buttons: {
                            confirm: {
