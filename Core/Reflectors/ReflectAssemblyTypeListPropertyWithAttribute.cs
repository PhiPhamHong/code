...
namespace Core.Reflectors
{
    ...
    public class ReflectAssemblyTypeListPropertyWithAttribute<TAttribute> : DictionaryCacheBase<Assembly, List<Pair<Type, List<Pair<PropertyInfo, TAttribute>>>>, ReflectAssemblyTypeListPropertyWithAttribute<TAttribute>> where TAttribute : Attribute
    {
    ...
    /// </summary>
    public class ReflectAssemblyClassInfoAttribute<T> : DictionaryCacheBase<Assembly, List<T>, ReflectAssemblyClassInfoAttribute<T>> where T : ClassInfoAttribute
    {
        /// <summary>
