...
namespace Manage.Timekeeper.Tools.Utilities
{
    internal class DeviceManipulator
    {
        ...
        public ICollection<UserInfo> GetAllUserInfo(DeviceClient objZkeeper, int machineNumber)
        {
        ...
        public ICollection<MachineInfo> GetLogData(DeviceClient objZkeeper, int machineNumber)
        {
        ...
        public ICollection<UserIDInfo> GetAllUserID(DeviceClient objZkeeper, int machineNumber)
        {
        ...
        public void GetGeneratLog(DeviceClient objZkeeper, int machineNumber, string enrollNo)
        {
            string name = null;
        ...
        public bool PushUserDataToDevice(DeviceClient objZkeeper, int machineNumber, string enrollNo)
        {
        ...
        public bool UploadFTPTemplate(DeviceClient objZkeeper, int machineNumber, List<UserInfo> lstUserInfo)
        {
        ...
        public object ClearData(DeviceClient objZkeeper, int machineNumber, ClearFlag clearFlag)
        {
        ...
        public bool ClearGLog(DeviceClient objZkeeper, int machineNumber)
        {
            return objZkeeper.ClearGLog(machineNumber);
        }


        public string FetchDeviceInfo(DeviceClient objZkeeper, int machineNumber)
        {
